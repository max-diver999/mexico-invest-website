...
<CtaBox
  title="Jungle development or marina address"
  description="Send us both and we will come back with the fee position, the rental permission and the resale evidence on each, rather than the developer's own comparison."
