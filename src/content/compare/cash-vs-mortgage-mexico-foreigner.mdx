...
![Cash Vs Mortgage Mexico Foreigner](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460979/more-group/mexico/compare/cash-vs-mortgage-mexico-foreigner/inline_1.jpg)
...
Cost of capital settles this comparison before any other consideration. Mexican non-resident lending prices near 11.45% on average fixed peso terms against a prime Playa net yield of 4.4%, so the structure runs negative by roughly 700 basis points from the first payment. A $200,000 loan therefore costs about $22,900 a year to service against a property producing $13,640 net. No appreciation assumption within the national 5% to 7% band closes that gap reliably, which is why foreign buyers in Mexico are overwhelmingly cash.
...
Core-satellite: Cash-flow Playa Centro unit (cash) + pre-construction Tulum option (developer plan), debt only where bank approves completed core. None of the three below is a leverage strategy in the US sense, because Mexican peso mortgages to foreigners price around 11% and dollar lending is scarce. What they have in common is that the debt sits somewhere other than on the Mexican asset, a US HELOC, a completed core property a bank will actually underwrite, while the Mexican purchase itself presents as clean cash.
...
Option A, All cash: One Gonzalo Guerrero 1BR ~$280K + closing ~$25K + reserve $95K. Net yield ~4.5%. Full control. The three options below are not equally weighted. Option B carries an 11% cost of capital against a 4.5% net yield, so it is negative-carry from day one and only works if you have a specific reason to keep $277K liquid; Option C spreads HOA and building-specific risk but doubles the closing costs and the management relationships. Option A is the default for most foreign buyers precisely because the arithmetic is this stark.
...
Cash mistakes: Skipping independent attorney because "cash is simple"; wiring without escrow; ignoring CFDI for future ISR basis. The most expensive mistake on the cash side is the third, and it is invisible for years: without CFDI invoices for the purchase and for every improvement, those amounts cannot be added to your cost basis when you sell, and the ISR on exit is calculated against a lower basis. Buyers routinely lose tens of thousands of dollars at sale to paperwork they declined to collect at purchase.
...
Cash: default for foreign buyers, speed, negotiation, yield clarity. If you read nothing else on this page, read these three lines. The structure is identical either way, fideicomiso, notario, ISAI, registry, and the only thing that changes is your cost of capital and how long the transaction takes.
