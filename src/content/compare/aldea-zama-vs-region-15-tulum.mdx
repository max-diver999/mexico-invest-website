...
Tulum context: [Tulum](/areas/tulum/) · Regional comparison: [Riviera Maya Guide](/guides/riviera-maya-property-investment-guide/).
...
<CtaBox
  title="Aldea Zama or Region 15, on your numbers"
  description="Give us the two units you are weighing and we will rebuild both cases on the same assumptions, so the comparison is not one developer's projection against another's."
