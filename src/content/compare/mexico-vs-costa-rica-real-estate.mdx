...
readingTime: 19
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1788438064/more-group/mexico/compare/mexico-vs-costa-rica-real-estate/hero.jpg"
heroAlt: "National Theatre of Costa Rica in San José with national flag and passers-by"
relatedSlugs:
...
![Mexico Vs Costa Rica Real Estate](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781461013/more-group/mexico/compare/mexico-vs-costa-rica-real-estate/inline_1.webp)
...
Costa Rica lets a foreigner hold coastal property in their own name with the same rights as a citizen; Mexico does not, and requires a bank trust within 50 km of any coast. That single difference sets the cost, the timeline and most of the paperwork on both sides, a fideicomiso adds $4,000–6,000 at setup and $500–2,000 a year thereafter, against nothing in Costa Rica outside the maritime concession zone.
...
Mexico wins on cash flow. Riviera Maya gross short-term rental yields of 6–9% at 60–75% occupancy sit above what comparable Costa Rican coastal product returns, because Mexico has more flights, more tourists and a deeper professional management market. Costa Rica compensates on ownership simplicity, not on income.

Restating both markets on net rather than gross is what makes this comparison usable. Riviera Maya gross of 6% to 9% at 60% to 75% occupancy becomes 4.3% to 4.5% net in prime Playa colonias after 25% to 35% management, HOA and the trust fee, and 2.6% in Tulum's oversupplied pockets. Costa Rican coastal product carries its own management, HOA and maintenance load on a smaller flight-served tourism base. Mexico's advantage is real and it is measured in one to two points of net, not in the four-point gap the gross figures imply.
...
Mexico costs more to buy into and takes longer: 5–10% of the price in ISAI, notario, trust setup and legal work, over 45–90 days. Costa Rica typically closes in 30–45 days at 3–5%, with no trust to constitute and no foreign-investment permit to obtain. The gap narrows over a long hold, but it is real money at the closing table.

Ownership simplicity is Costa Rica's genuine advantage and it has a price on the Mexican side. A foreigner takes direct fee-simple title in Costa Rica anywhere, while Mexican coastal property requires a fideicomiso at $2,500 to $4,000 plus $500 to $800 a year, roughly $8,300 to $13,500 across a ten-year hold. Against that, Mexican closing costs of 5% to 10% are broadly comparable to Costa Rican transfer taxes and legal fees. The trust is a cost and an administrative step, not a limitation on what you can do with the property.
...
Both countries tax rental income and gains, but Mexico's default rates for a non-resident are calculated on gross and are punitive until you register an RFC, 25% of gross rent, or 25% of gross sale price at exit. Costa Rica taxes rental income at a flat rate on a net basis and levies capital gains at 15%. Property taxes favour Mexico: predial is typically 0.1–0.3% of a cadastral value that sits well below market.
...
Mexico is the larger and more liquid market by an order of magnitude: thousands of foreign purchases a year, organised broker networks in the main corridors, and a professional services layer that Costa Rica's smaller volumes cannot support outside Guanacaste. Liquidity matters most on the way out, which is where the difference between the two shows up.
...
Mexico has the flights and Costa Rica has the nature. Cancún alone handles more than 30 million passengers a year against Costa Rica's two international airports combined, which decides how easily guests reach your property and how long the season runs. Costa Rica returns the favour on healthcare rankings, political stability and biodiversity, the things that keep people once they arrive.
...
The risk profiles are different in kind, not degree. Mexico's are legal and structural: ejido title, trust mechanics, municipal permit enforcement. Costa Rica's are economic and physical: a smaller buyer pool on exit, higher construction and labour costs, and squatter-rights claims on unoccupied land. Neither country's risks are avoidable by choosing the other.
...
Choose Mexico for yield, liquidity and flight access; choose Costa Rica for direct ownership, political stability and a nature-led lifestyle. The decision is rarely close once you say which of those you are optimising for, the mistake is buying in one country on the criteria that favour the other.
...
The two markets trade against each other on three axes, and a buyer who is honest about which one they actually care about will find the decision straightforward. Mexico wins on yield by roughly two to three percentage points and on liquidity by a wide margin, larger markets, faster transaction cycles, and tourism infrastructure deep enough to support rental demand year-round. Costa Rica wins on ownership simplicity, since a foreigner can hold title directly with no restricted-zone equivalent and no annual trust fee. Transaction costs and lifestyle preference decide the rest. What follows sets out each side's case in full.
