...
<CtaBox
  title="Choosing between two coastlines"
  description="Send us what you are considering and we will come back with the ownership structure, the running cost and the resale depth in each country on comparable property."
