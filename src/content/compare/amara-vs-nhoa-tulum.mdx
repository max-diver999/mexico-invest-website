...
Context: [Amara Tulum](/projects/amara-tulum/) · [NHOA Aldea Zama](/projects/nhoa-aldea-zama/) · [Grupo Emerita](/developers/grupo-emerita/) · [Tulum](/areas/tulum/).
...
<CtaBox
  title="Two Tulum projects, one honest comparison"
  description="Send both and we will come back with delivery record, HOA position, rental permission and what comparable units in each have actually resold for."
