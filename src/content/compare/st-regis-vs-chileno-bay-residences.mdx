...
<CtaBox
  title="Two branded projects on the same corridor"
  description="Tell us which unit types you are considering and we will come back with the fee structures, the rental programme terms and what has actually closed in each."
