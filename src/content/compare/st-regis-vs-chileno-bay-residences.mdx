...
readingTime: 20
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1788439500/more-group/mexico/compare/st-regis-vs-chileno-bay-residences/hero.jpg"
heroAlt: "Aerial view along Playa Palmilla on the Los Cabos corridor: calm Sea of Cortez to the left, a wide empty beach, and low-rise villas climbing the headland at the far end"
...
![St Regis Vs Chileno Bay Residences, the Cabo corridor](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781461058/more-group/mexico/compare/st-regis-vs-chileno-bay-residences/inline_1.jpg)
...
Program enrollment fees are the line most buyers discover late, and at this price band they are large enough to change the decision. On a $6M St. Regis residence, budgeting 5–10% for closing means $300,000 to $600,000 in ISAI, notario, registry and legal costs before the fideicomiso, and a branded-residence enrollment fee of $50,000 to $200,000 sits on top of that. Total cash at closing therefore lands between $350,000 and $800,000 on a $6M contract, or roughly 6% to 13% of price. Ask for the enrollment fee in writing during negotiation, because unlike ISAI it is set by the operator and is one of the few closing costs at this level that is genuinely negotiable.
...
Stress-testing turns the published 2.0–3.5% band into something a buyer can act on. Take a $6M Chileno Bay residence at a $2,500 blended ADR and 70 booked nights: gross room revenue is $175,000, a 35% program fee removes $61,250, HOA at $3,500 a month removes $42,000, and predial, insurance, reserves and the trust fee take a further $25,000. Net cash is roughly $47,000, or 0.8% on basis. Apply the 30% ADR haircut the section recommends and gross falls to $122,500 while the fixed costs do not move, leaving about $2,000. Ultra-luxury Los Cabos rental income is a partial offset to carrying cost, not a return.
...
The two operators run fundamentally different models, and the difference shows up in owner experience long before it shows up in returns. St. Regis operates under Marriott International protocols: standardised service procedures, global booking distribution and Bonvoy integration, which brings reach and consistency, and, because the residences sit inside the Quivira master plan, a layered fee structure with master-plan coordination requirements on top of the brand's own. Chileno Bay under Auberge is boutique by design, with property-specific operations, personalised service and a simpler fee structure. Neither is better in the abstract; they suit different tolerances for complexity.
...
The risk profiles here are almost inverse, which is the most useful thing to know before reading the detail. St. Regis carries the risks of a new asset: Q1 2026 delivery, programme fee escalation from a brand with room to move, Quivira master-plan assessment exposure, fee-structure opacity, and no comparable sales to anchor resale pricing until the first units trade. Chileno Bay carries the risks of an established one: building ageing, Auberge programme changes to terms already in force, hurricane exposure requiring comprehensive cover, and ultra-luxury market concentration. One set resolves with time; the other arrives with it.
...
These two branded residences fail in different ways, so the diligence splits before it converges. St. Regis is a Marriott flag inside the Quivira master plan, which means the questions are about completion guarantees for the Q1 2026 phases, the branded residence agreement's fee structure, and how Marriott's residential programmes have actually performed in other markets, data that exists and can be requested. Chileno Bay is Auberge-operated and further along, so the same questions get different answers. Model both at realistic owner-use assumptions rather than at full-year rental availability, because at this tier owner nights are the single largest hidden cost.
