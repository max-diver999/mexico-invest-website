...
readingTime: 14
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1788436236/more-group/mexico/compare/gran-tulum-vs-101-park/hero.jpg"
heroAlt: "Pedestrians and cyclists on a shop-lined street in Tulum town"
relatedSlugs:
  - "gran-tulum"
  - "101-park-tulum"
  - "tulum"
...
![Gran Tulum and 101 Park property markets compared](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460993/more-group/mexico/compare/gran-tulum-vs-101-park/inline_1.jpg)
...
Overlap in the middle of the two ranges is where the real comparison sits. A 2BR standard costs $450,000 to $650,000 at 101 Park and $395,000 to $495,000 at Gran Tulum, so a buyer at the $450,000 to $495,000 mark can have either, and the decision turns on delivery status rather than on price. 101 Park is delivering and lets you inspect a finished unit, read actual HOA invoices and interview managers who already run units in the building; Gran Tulum is Phase 2 off-plan, which means a discount on paper and construction risk in practice. Paying the same money for delivered product removes an entire risk category.
...
Testing the entry-price argument with numbers shows it is thinner than it reads. At a $155 ADR and 63% annual occupancy, a 101 Park 1BR grosses about $35,600; after 27% management, a $500 monthly HOA and the trust and tax stack, net lands near $12,000 on a $290,000 basis, or roughly 4.1%. A Gran Tulum lock-off at $395,000 can run two revenue streams but competes for the same guest pool in the same master plan, and its second key typically adds 25% to 35% of gross rather than doubling it. Lower entry does win on percentage, but by tens of basis points rather than by a tier.
...
The two projects sit inside the same master plan at different stages of it, and that single fact drives most of the operational difference between them. 101 Park runs on completed Phase 1 infrastructure, utilities connected, road access built, security systems operating, which means a unit there is rentable from handover with no dependency on future construction. Gran Tulum requires Phase 2 to be delivered: utility expansion, road network extension and amenity build-out that are scheduled rather than existing. Both may end up equivalent; only one of them is equivalent today.
...
## Environmental compliance and development permission
...
## Market timing and investment horizon recommendation
...
Project analysis: [101 Park Tulum](/projects/101-park-tulum/) · [Gran Tulum](/projects/gran-tulum/) · [SIMCA developer profile](/developers/simca-desarrollos/).
