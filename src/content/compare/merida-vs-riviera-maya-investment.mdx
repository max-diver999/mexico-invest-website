...
<CtaBox
  title="Inland value against coastal rental"
  description="Send us the budget and we will come back with what Merida buys against the coast, including the trust cost that applies to one and not the other."
