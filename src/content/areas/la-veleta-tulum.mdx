...
Comparing the entry and premium rows shows how little the ticket does for the return in La Veleta. An $180K entry 1BR at 6.8% gross produces about $12,240 a year before costs and nets roughly $6,300, or 3.5%. A $300K premium unit at 6.2% gross produces about $18,600 and nets roughly $9,000, or 3.0%. The premium buyer has committed 67% more capital to earn 43% more net income, and the gap is explained almost entirely by an HOA that runs $250 a month at the bottom of the market and $600 or more at the top. In La Veleta the HOA statement is a more reliable predictor of net yield than the purchase price.
...
Translating the HOA spread into basis points is the fastest way to see why it dominates building selection here. On a $220K standard 1BR grossing about $14,300 a year, a $250 monthly fee costs $3,000 annually and consumes 21% of gross; a $650 fee costs $7,800 and consumes 55%. That single line is a 218 basis point swing in net yield on an identical purchase price, which is more than the entire gap between La Veleta's best and worst pricing tiers. Request the last twenty-four months of HOA statements, the reserve balance and the delinquency rate before agreeing a price, because a fee that low today with no reserve behind it will not stay low.
...
La Veleta development spans multiple years creating variation in construction quality, infrastructure completion, and community establishment where newer phases may lack proven operational systems while established sections demonstrate mature STR performance and guest satisfaction. For a buyer that means the phase matters as much as the building: a newer section may carry a lower HOA today precisely because reserves have not been funded and the first capital repairs have not arrived.
...
Essential verification includes HOA financial health, STR policy documentation, building permit status, utility reliability, and community atmosphere assessment to avoid post-purchase operational surprises given extreme building variance within La Veleta boundaries. HOA financial health is the item that outranks the rest here, because La Veleta's $250 to $600 monthly range is a 218 basis point swing in net yield on an identical purchase price.
...
Assuming zone-wide performance uniformity, underestimating HOA variance impact, purchasing without STR verification, and selecting buildings based on price alone without community assessment represent frequent errors reducing actual returns below projections. Selecting on price alone is the costliest of the four: an $180,000 entry unit at 3.5% net returns $6,300 while a $300,000 premium unit at 3.0% returns $9,000, so the ticket buys income but not efficiency.
