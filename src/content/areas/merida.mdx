...
Merida represents Mexico's most steady real estate appreciation story, 9.4% YoY growth with balanced supply-demand and no speculative bubbles. Two things make Mérida structurally different from every coastal market on this site: it sits outside the restricted zone, so a foreigner takes direct title with no trust to constitute or renew, and its demand is domestic and residential rather than touristic. That combination produces slower, steadier appreciation and a rental market measured in annual leases rather than nightly rates.
...
Merida offers Mexico's most predictable real estate appreciation, 9.4% YoY growth with cultural authenticity, safety, and healthcare depth supporting steady expat in-migration. Buy Mérida for direct title, low carrying costs and steady long-term tenancy, and underwrite it at 3.5–4.5% net on annual leases rather than at coastal short-term rental figures. The absence of a trust saves $2,500–4,000 at closing and $500–800 every year thereafter, which over a twenty-year hold is the single largest structural advantage available to a foreign buyer in Mexico.
