...
For the coast alternative see [homes for sale in Mexico](/guides/homes-for-sale-mexico/), for the comparison with the Caribbean see [Merida against Riviera Maya](/compare/merida-vs-riviera-maya-investment/), and for the ownership route see [the restricted zone explained](/guides/mexico-restricted-zone-explained/). Buyers who want the same state with the sea an hour north should read [Chelem and Progreso](/areas/chelem-progreso/), where the beach houses that Merida residents keep as weekend places are sold.
