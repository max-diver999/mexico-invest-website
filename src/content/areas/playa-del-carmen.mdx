...
Playa is the corridor's liquidity market, which makes it the wrong answer for four fairly common briefs. If any of these describes you, the better market is elsewhere:
...
Playa's competition is not other Playa buildings, it is the three corridors buyers weigh against it — each trading liquidity for something else:
...
Colonia averages hide a 300-basis-point spread between buildings on the same street, so the useful comparison is building against building rather than area against area. Individual reviews:
