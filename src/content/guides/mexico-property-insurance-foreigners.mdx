...
**Coverage limits:** Typically based on replacement cost, not market value — crucial distinction in Mexico where construction costs may exceed property market values.
...
| **Deductibles** | Often percentage-based (2-5% of coverage limit) rather than fixed dollar amounts |
...
**Coverage details:** Earthquake deductibles are typically high (10-15% of coverage limit) and coverage may have sub-limits for masonry and older construction types.
...
- **General liability:** Standard coverage for slip-and-fall, accidents on property
- **STR liability:** Enhanced coverage for short-term rental guest injuries and property damage
...
**Business interruption insurance:** Covers lost rental income during property repairs from covered losses.

**Coverage calculation:** Based on historical rental income or projected bookings during repair period.
...
- **Monitored alarm systems:** 10-20% discounts for professionally monitored security
