...
![Land's End Medano Bay](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460774/more-group/mexico/guides/how-to-sell-mexico-property-from-abroad/inline_1.jpg)
...
## Selecting Mexican legal counsel

Remote property sales require Mexican attorneys with specific experience in cross-border transactions, consulate POA coordination, and remote closing management, general Mexican lawyers lack necessary procedural experience. Attorney selection criteria for optimal remote coordination: Ask specifically whether they have handled a consulate-executed power of attorney and a fideicomiso beneficiary assignment before — those two mechanics are where remote sales stall, and general property counsel often has not done either.
...
## ISR capital gains tax implications
...
Which calculation method the notario applies changes the outcome substantially, and documentation decides it. Withholding runs either roughly 25% of the gross sale price or up to 35% of the net gain, and the net method only becomes available when a documented cost basis is presented. On a $420,000 sale, 25% of gross is $105,000 withheld; 35% of a $45,000 documented gain is $15,750. The difference is not a tax rate argument — it is whether your CFDI purchase and improvement invoices exist and reach the notario before closing.
...
Authority granted in the power of attorney is the mistake with no workaround. A poder drafted for a straightforward sale may not empower your attorney to claim a primary-residence exemption or to present cost-basis documentation on your behalf, and the notario cannot act on authority the instrument does not contain. Fixing it means executing a new POA with apostille and certified translation from abroad, which adds 2 to 4 weeks to a closing already in motion. Have a Mexican CPA review the draft powers before you sign, not after.
...
## Fideicomiso assignment mechanics

Remote fideicomiso sales require bank beneficiary assignment coordinated by your POA attorney simultaneous with notario property transfer, the trust structure adds coordination complexity but does not prevent remote execution. Process flow for trust assignment: The trust assignment and the deed transfer have to happen simultaneously, which means the bank, the notario and your attorney all working to one date. Start the bank's side four to six weeks before the intended closing.
...
## Timeline and coordination workflow
...
The five most expensive remote sale mistakes involve POA scope limitations, CFDI documentation gaps, currency coordination failures, buyer qualification assumptions, and post-closing Mexican tax obligations. Avoid these patterns: The costliest is a power of attorney drawn too narrowly to cover the trust assignment — discovered on closing day, with the buyer in the notario's office and the seller on another continent.
...
Successful remote Mexico property sales require secure document sharing, video conference coordination, and real-time transaction monitoring systems to overcome geographic and time zone challenges. Modern remote sale technology stack: The practical requirements are ordinary and worth agreeing in advance: a shared document repository, scheduled video calls at Mexican business hours, and a single named person who confirms wire instructions by voice.
...
The four questions below qualify an attorney for remote coordination specifically, which is a narrower skill than Mexican property law generally. An attorney who has never coordinated a consulate-executed poder with a trustee bank will learn on your transaction.
...
Most of the preparation happens before the power of attorney is executed, because a poder drafted without the full document set behind it will be too narrow. Assemble the trust deed, the CFDI file, the current predial and the HOA good-standing letter first.
...
## Advanced topics: corporate ownership and estate CO

Sellers holding property through Mexican corporations or complex estate structures require specialized POA provisions and legal coordination beyond standard individual property sales. Consider enhanced legal representation for: A corporate seller adds a layer at every step — signatory authority, corporate resolutions and the entity's own tax position — so the POA and the timeline both need drafting around it rather than adapting to it.
