...
1. What specific CFDI will I receive at closing for each payment line? Who generates CFDI for attorney fees, trust setup, and ISAI? The three questions that matter: will I hold an RFC before the first payment, who issues the CFDIs on each cost, and what will the withholding be at sale under each method. An advisor who cannot answer all three at purchase will not have better answers later.
