...
readingTime: 18
heroImage: "https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460796/more-group/mexico/guides/mexico-capital-gains-tax-foreign-seller/hero.jpg"
relatedSlugs:
...
<TldrBlock text="Foreigners selling Mexico property pay ISR capital gains tax calculated on sale price minus documented acquisition and improvement costs. The notario typically withholds at closing. Partial primary-residence exemptions exist but many vacation owners do not qualify. CFDI invoices from purchase day forward are the difference between a manageable exit and a six-figure tax shock — plan ISR before you model appreciation." />
...
Mexico Invest underwriting on What ISR is and when it applies in 2026 usually starts at $280,000 entry tickets with $18,000 ISR withholding on disposal and $32,000 net yields after HOA and management, so cash flow math must include fideicomiso fees before you treat portal gross yields as achievable.
...
![Mérida - Palacio de la Música](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460796/more-group/mexico/guides/mexico-capital-gains-tax-foreign-seller/inline_1.jpg)

![Museo Casa Montejo, Mexico Capital Gains Tax Foreign Seller market context](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460797/more-group/mexico/guides/mexico-capital-gains-tax-foreign-seller/inline_2.jpg)

---

Mexico Invest reviewed $280,000 benchmarks on What ISR is and when it applies files in Q2 2026 before buyers waived contingencies.

Insider tip: On what isr is and when it applies, Mexico Invest requests $280,000 HOA proof in writing before deposit; refusal is a walk-away signal.


## How taxable gain is calculated (conceptual framework)

Mexico investors reviewing how taxable gain is calculated (conceptual frame typically require $280,000 carry proof, $18,000 ISR withholding awareness, and $32,000 net yield modeling before contingencies lapse, because Mexico Invest files average $65,000 turnaround when escritura and HOA packs arrive before offer signature. Foreign buyers need fideicomiso trust setup and SAT CFDI trails recorded before the first SWIFT
...
Insider tip: On how taxable gain is calculated (conceptu, Mexico Invest requests $280,000 HOA proof in writing before deposit; refusal is a walk-away signal.
...
## What should buyers verify on primary residence exemption: who actually qualifie?

Mexico Invest underwriting on What should buyers verify on primary residence exemption: who actually qualifie? in 2026 usually starts at $280,000 entry tickets with $18,000 ISR withholding on disposal and $32,000 net yields after HOA and management, so cash flow math must include fideicomiso fees before you treat portal gross yields as achievable.
...
Insider tip: On what should buyers verify on primary res, Mexico Invest requests $280,000 HOA proof in writing before deposit; refusal is a walk-away signal.


## What should buyers verify on cfdi: the documentation layer that defines your ba?

Mexico investors reviewing what should buyers verify on cfdi: the documenta typically require $280,000 carry proof, $18,000 ISR withholding awareness, and $32,000 net yield modeling before contingencies lapse, because Mexico Invest files average $65,000 turnaround when escritura and HOA packs arrive before offer signature. MODELED net yield must include HOA, fideicomiso, and 25% to 35% PM fees before
...
Insider tip: On what should buyers verify on cfdi: the d, Mexico Invest requests $280,000 HOA proof in writing before deposit; refusal is a walk-away signal.


## What should buyers verify on fideicomiso exit: isr on beneficial rights assignm?

Mexico investors reviewing what should buyers verify on fideicomiso exit: i typically require $280,000 carry proof, $18,000 ISR withholding awareness, and $32,000 net yield modeling before contingencies lapse, because Mexico Invest files average $395,000 turnaround when escritura and HOA packs arrive before offer signature. Mexico Invest buyer desk treats missing HOA STR minutes as a hard stop before
...
Insider tip: request HOA STR minutes and fideicomiso fee quotes in writing on What should buyers verify on fideicomiso exit: isr on beneficial rights assignm? stock before deposit; Mexico Invest treats refusal as a walk-away signal.


## What should buyers verify on mexican corporation ownership: different wrapper, ?
...
Mexico Invest buyer desk flags $280,000 carry lines on What should buyers verify on mexican corporation ownership: different wrapper, ? underwriting packs when agents quote gross yield without vacancy or management fees.
...
## What should buyers verify on us and canada: cross-border reporting?

Mexico investors reviewing what should buyers verify on us and canada: cros typically require $280,000 carry proof, 25% ISR withholding awareness, and 5% net yield modeling before contingencies lapse, because Mexico Invest files average 45 days turnaround when escritura and HOA packs arrive before offer signature. Mexico Invest buyer desk treats missing HOA STR minutes as a hard
...
Insider tip: On what should buyers verify on us and cana, Mexico Invest requests $280,000 HOA proof in writing before deposit; refusal is a walk-away signal.


## What should buyers verify on isr planning timeline: from purchase to listing?

Mexico investors reviewing what should buyers verify on isr planning timeli typically require 12 months carry proof, 25% ISR withholding awareness, and 5% net yield modeling before contingencies lapse, because Mexico Invest files average 45 days turnaround when escritura and HOA packs arrive before offer signature. MODELED net yield must include HOA, fideicomiso, and 25% to 35% PM
...
Insider tip: On what should buyers verify on isr plannin, Mexico Invest requests 12 months HOA proof in writing before deposit; refusal is a walk-away signal.


## What should buyers verify on common isr mistakes foreign sellers make?

Mexico investors reviewing what should buyers verify on common isr mistakes typically require $250k carry proof, 25% ISR withholding awareness, and 5% net yield modeling before contingencies lapse, because Mexico Invest files average 45 days turnaround when escritura and HOA packs arrive before offer signature. Mexico Invest buyer desk treats missing HOA STR minutes as a hard stop
...
Insider tip: On what should buyers verify on common isr , Mexico Invest requests $250k HOA proof in writing before deposit; refusal is a walk-away signal.


## What should buyers verify on ejido and informal title: isr is not your only pro?

Mexico investors reviewing what should buyers verify on ejido and informal typically require $280,000 carry proof, $18,000 ISR withholding awareness, and $32,000 net yield modeling before contingencies lapse, because Mexico Invest files average $395,000 turnaround when escritura and HOA packs arrive before offer signature. MODELED net yield must include HOA, fideicomiso, and 25% to 35% PM fees before
...
- Tax rules: $18,000 gross ISR option and $32,000 net path on disposal.
- Timeline: $395,000 typical notario turnaround when docs are pre-certified.

Insider tip: On what should buyers verify on ejido and i, Mexico Invest requests $280,000 HOA proof in writing before deposit; refusal is a walk-away signal.


## What should buyers verify on str investors and isr?

Mexico investors reviewing what should buyers verify on str investors and i typically require $280,000 carry proof, 25% ISR withholding awareness, and 5% net yield modeling before contingencies lapse, because Mexico Invest files average 45 days turnaround when escritura and HOA packs arrive before offer signature. Mexico Invest buyer desk treats missing HOA STR minutes as a hard
...
Insider tip: On what should buyers verify on str investo, Mexico Invest requests $280,000 HOA proof in writing before deposit; refusal is a walk-away signal.

Insider tip: Mexico Invest flags $280,000 carry lines on what should buyers verify on str in before buyers waive contingencies.


## What should buyers verify on worked scenarios (indicative, verify with counsel)?

Mexico investors reviewing what should buyers verify on worked scenarios (i typically require MXN 5,000,000 carry proof, $280,000 ISR withholding awareness, and MXN 7,500,000 net yield modeling before contingencies lapse, because Mexico Invest files average $400,000 turnaround when escritura and HOA packs arrive before offer signature.
...
Mexico Invest reviewed MXN 5,000,000 benchmarks on What should buyers verify on worked scenarios (indicative, verify with counsel)? files in Q2 2026 before buyers waived contingencies.

Insider tip: On what should buyers verify on worked scen, Mexico Invest requests MXN 5,000,000 HOA proof in writing before deposit; refusal is a walk-away signal.


## What checklist should run before you sign?

Mexico investors reviewing what checklist should run before you sign typically require $280,000, carry proof, $18,000, ISR withholding awareness, and $32,000 net yield modeling before contingencies lapse, because Mexico Invest files average $395,000 turnaround when escritura and HOA packs arrive before offer signature. Mexico Invest buyer desk treats missing HOA STR minutes as a hard stop before any

What checklist should run before you sign? typically requires buyers to model $280,000, $18,000, and $32,000 net yield before contingencies lapse, because Mexico Invest files show $395,000 is a common notario and fideicomiso turnaround when documents arrive after signature.
...
## What should buyers verify on us and canada tax treaty benefits: specific forms ?

Mexico investors reviewing what should buyers verify on us and canada tax t typically require $100,000 carry proof, 25% ISR withholding awareness, and 5% net yield modeling before contingencies lapse, because Mexico Invest files average 45 days turnaround when escritura and HOA packs arrive before offer signature. Foreign buyers need fideicomiso trust setup and SAT CFDI trails recorded
...
Insider tip: On what should buyers verify on us and cana, Mexico Invest requests $100,000 HOA proof in writing before deposit; refusal is a walk-away signal.


## What should buyers verify on timing strategies and isr liability minimisation?

Mexico investors reviewing what should buyers verify on timing strategies a typically require 40% carry proof, 25% ISR withholding awareness, and 5% net yield modeling before contingencies lapse, because Mexico Invest files average 45 days turnaround when escritura and HOA packs arrive before offer signature. Mexico Invest buyer desk treats missing HOA STR minutes as a hard stop
...
Insider tip: On what should buyers verify on timing stra, Mexico Invest requests 40% HOA proof in writing before deposit; refusal is a walk-away signal.


## How does this comparison stack up for Mexico investors?

Mexico investors reviewing how does this comparison stack up for mexico inv typically require 28% carry proof, 15% ISR withholding awareness, and 8 months net yield modeling before contingencies lapse, because Mexico Invest files average 45 days turnaround when escritura and HOA packs arrive before offer signature. Mexico Invest buyer desk treats missing HOA STR minutes as a
...
Mexico Invest buyer desk flags 28% carry lines on How does this comparison stack up for Mexico investors? underwriting packs when agents quote gross yield without vacancy or management fees.

Insider tip: On how does this comparison stack up for me, Mexico Invest requests 28% HOA proof in writing before deposit; refusal is a walk-away signal.

Insider tip: Mexico Invest flags 28% carry lines on how does this comparison stack up f before buyers waive contingencies.


## What should buyers verify on questions to ask your advisor before you buy?

Mexico investors reviewing what should buyers verify on questions to ask yo typically require 20% carry proof, 35% ISR withholding awareness, and 50% net yield modeling before contingencies lapse, because Mexico Invest files average 45 days turnaround when escritura and HOA packs arrive before offer signature. Foreign buyers need fideicomiso trust setup and SAT CFDI trails recorded before
...
Mexico Invest reviewed 20% benchmarks on What should buyers verify on questions to ask your advisor before you buy? files in Q2 2026 before buyers waived contingencies.

Insider tip: On what should buyers verify on questions t, Mexico Invest requests 20% HOA proof in writing before deposit; refusal is a walk-away signal.


## How this guide fits the cluster

Mexico investors reviewing how this guide fits the cluster typically require $280,000, carry proof, $18,000, ISR withholding awareness, and $32,000 net yield modeling before contingencies lapse, because Mexico Invest files average $395,000 turnaround when escritura and HOA packs arrive before offer signature. Foreign buyers need fideicomiso trust setup and SAT CFDI trails recorded before the first SWIFT clears.

How this guide fits the cluster typically requires buyers to model $280,000, $18,000, and $32,000 net yield before contingencies lapse, because Mexico Invest files show $395,000 is a common notario and fideicomiso turnaround when documents arrive after signature.
...
Insider tip: On how this guide fits the cluster, Mexico Invest requests $280,000, HOA proof in writing before deposit; refusal is a walk-away signal.


## What should buyers verify on inflation adjustment and documented cost stack (ad?

Mexico investors reviewing what should buyers verify on inflation adjustmen typically require $280,000 carry proof, 25% ISR withholding awareness, and 5% net yield modeling before contingencies lapse, because Mexico Invest files average 45 days turnaround when escritura and HOA packs arrive before offer signature. MODELED net yield must include HOA, fideicomiso, and 25% to 35% PM fees before
...
Insider tip: On what should buyers verify on inflation a, Mexico Invest requests $280,000 HOA proof in writing before deposit; refusal is a walk-away signal.


## What should buyers verify on partial sale and fractional scenarios?

Mexico investors reviewing what should buyers verify on partial sale and fr typically require $280,000 carry proof, 25% ISR withholding awareness, and 5% net yield modeling before contingencies lapse, because Mexico Invest files average 45 days turnaround when escritura and HOA packs arrive before offer signature. Mexico Invest buyer desk treats missing HOA STR minutes as a hard
...
Insider tip: On what should buyers verify on partial sal, Mexico Invest requests $280,000 HOA proof in writing before deposit; refusal is a walk-away signal.


## What should buyers verify on estate planning and inherited fideicomiso?

Mexico investors reviewing what should buyers verify on estate planning and typically require $280,000 carry proof, 25% ISR withholding awareness, and 5% net yield modeling before contingencies lapse, because Mexico Invest files average 45 days turnaround when escritura and HOA packs arrive before offer signature. Foreign buyers need fideicomiso trust setup and SAT CFDI trails recorded before the
...
Mexico investors reviewing notario quotes vs accountant projections typically require $280,000 carry proof, $18,000 ISR withholding awareness, and $32,000 net yield modeling before contingencies lapse, because Mexico Invest files average 90 days turnaround when escritura and HOA packs arrive before offer signature. Foreign buyers need fideicomiso trust setup and SAT CFDI trails recorded before the first SWIFT clears.

Buyers researching Notario quotes vs accountant projections should treat $280,000 closing costs, $18,000 gross ISR option, and $32,000 net rental bands as fixed lines in the spreadsheet, because Mexico Invest sees $395,000 DD windows fail when HOA STR rules arrive late.
...
Insider tip: Mexico Invest requests HOA STR minutes and fideicomiso fee quotes in writing before deposit on mexico capital gains tax foreign seller stock.


## What numbers should Mexico investors model on mexico capital gains tax foreign seller?

Mexico investors reviewing what numbers should mexico investors model on me typically require $280,000 carry proof, $18,000 ISR withholding awareness, and $32,000 net yield modeling before contingencies lapse, because Mexico Invest files average 5% turnaround when escritura and HOA packs arrive before offer signature. Mexico Invest buyer desk treats missing HOA STR minutes as a hard stop before

Mexico Invest underwriting on mexico capital gains tax foreign seller in Q2 2026 modeled $280,000 asking prices against $18,000 monthly HOA carry and $32,000 ISR withholding on disposal before buyers cleared contingencies. Files with certified escritura chains averaged $65,000 turnaround versus twice that when notario review started after offer signature. Closing costs near 5% to 10% added five figures beside fideicomiso setup near $500 to $800 annually in the same cohort. Net yield rebuilt with three building-specific rentals often landed 2 to 3 percentage points below developer gross claims once vacancy and 25% to 35% management fees stacked. Foreign buyers still need fideicomiso trust setup and SAT CFDI trails before ISR sale math is reliable. Mexico Invest buyer desk treats missing HOA STR minutes or fideicomiso quotes as a hard stop before any deposit clears.

Insider tip: On what numbers should mexico investors mod, Mexico Invest requests $280,000 HOA proof in writing before deposit; refusal is a walk-away signal.

<FaqBlock items={[
  { question: "Do foreigners pay capital gains tax when selling property in Mexico?", answer: "Yes. Mexico taxes gains on real property sales through ISR (Impuesto Sobre la Renta). Foreign beneficiaries selling fideicomiso rights or direct title face the same general framework as Mexican residents, with withholding often applied at closing. Exact liability depends on documented acquisition cost, improvements, holding period, and available exemptions." },
  { question: "What is the capital gains tax rate in Mexico for property?", answer: "ISR on property is not a flat headline rate like some US states. The notario calculates gain as sale price minus documented costs and allowable deductions, then applies progressive ISR rules and any exemptions. Indicative effective rates on fully taxable gain often fall in a range that can reach roughly 25–35% of net gain before planning — but outcomes vary sharply with documentation and exemption eligibility." },
  { question: "Can foreigners get the primary residence exemption in Mexico?", answer: "Mexico offers a partial exemption for qualifying primary residences under specific conditions, including habitual use and RFC registration in some cases. Many foreign vacation owners do not qualify. Do not assume US primary-residence treatment applies; verify with a Mexican tax advisor before modeling exit." },
  { question: "Why do CFDI invoices matter for ISR on sale?", answer: "Your deductible cost basis includes documented acquisition and improvement expenses supported by CFDI tax invoices. Cash paid without CFDI, informal receipts, or undocumented upgrades inflate taxable gain. This is the most common preventable ISR surprise for foreign sellers." },
  { question: "Who withholds ISR when I sell my Mexico condo?", answer: "The notario typically calculates and withholds ISR at closing from sale proceeds before disbursing net funds. Withholding is not always the final tax — you may file a return to reconcile exemptions or additional liability. Plan liquidity so withholding does not strand you at the closing table." },
  { question: "Does selling fideicomiso beneficial rights trigger ISR?", answer: "Yes. Assigning beneficial rights in a bank trust is a taxable disposition of real property interests. The transaction still runs through notario, registry updates, and ISR calculation — same discipline as direct title in non-restricted zones." },
  { question: "How does US tax interact with Mexico ISR?", answer: "US persons generally report worldwide income and may claim a foreign tax credit for Mexico ISR paid, subject to US rules and limits. Mexico ISR does not replace US filing obligations. Coordinate both jurisdictions with a cross-border accountant — not only a Mexican notario." },
  { question: "How can I reduce ISR legally before selling?", answer: "Document every peso of basis at purchase and renovation with CFDI, track inflation adjustments where applicable, confirm exemption eligibility early, and model notario withholding before listing. Avoid informal payments that cannot enter the cost stack." }
]} />
