...
- Sell direct title outside the restricted zone (San Miguel, Guadalajara, interior markets)
...
For the ownership context before exit, start with [can foreigners buy property in Mexico](/guides/can-foreigners-buy-property-mexico/) and [Fideicomiso Mexico Explained](/guides/fideicomiso-mexico-explained/).
...
![Museo Casa Montejo](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460797/more-group/mexico/guides/mexico-capital-gains-tax-foreign-seller/inline_2.jpg)

---

## How taxable gain is calculated (conceptual framework)

Taxable gain equals sale price minus documented acquisition costs, improvements, and allowable deductions under Mexican tax rules. The notario and tax calculation start from: The critical word is "documented": costs without a CFDI do not exist for this calculation, which is why a seller with a complete invoice file pays 35% of a small gain while a seller without one pays 25% of the entire sale price.
...
Recovering over-withheld ISR is possible and slow, which is why documentation matters more than the refund route. A seller with a weak CFDI trail on a $420,000 sale might face withholding calculated against a $140,000 gain rather than the $45,000 the invoices would have supported, a difference of roughly $24,500 held at closing. Reclaiming it requires a Mexican RFC, a formal refund application to SAT and a Mexican accountant, and typically runs 6 to 18 months with no certainty. Assembling invoices before listing costs nothing; recovering money afterwards costs time, fees and often part of the claim.
...
Underwriting the exemption as base case is the error this table exists to prevent. Mexican law exempts the gain on a qualifying casa habitacion only where the SALE PRICE sits at or under 700,000 UDI, roughly MXN 6.2 million or USD 340,000 at 2026 unit values, and the tests are habitual residence, RFC tax residency and no prior exempt sale in the previous three years. A US owner spending 4 months a year on site and renting the rest fails on habitual use regardless of intent. Model the exit fully taxable, and if a Mexican tax adviser later confirms the exemption applies, treat the saving as upside rather than as a return you already spent.
...
## CFDI: the documentation layer that defines your ba
...
## Mexican corporation ownership: different wrapper

Mexican corporations holding property face corporate-level tax on disposition plus additional compliance, usually creating double taxation burden rather than ISR savings. If property sits in a Mexican corporation, sale may trigger: That is the opposite of what the structure is usually sold for. A corporation earns its keep on commercial property or a portfolio, not as an ISR-avoidance wrapper around one residential condo.
...
Effective ISR management requires systematic documentation and planning from purchase day through sale closing, not emergency planning when listing the property. Follow this timeline for optimal tax position: The single highest-value action is at purchase, not at sale: register an RFC and start collecting CFDIs from the first payment. Everything else in the timeline is maintenance of that decision.
...
The most expensive ISR mistakes are preventable documentation gaps and incorrect assumptions about US tax rules applying in Mexico. Avoid these patterns: The most costly is assuming US rules travel, that a 1031 exchange defers Mexican tax, or that a primary-residence exclusion applies. Neither does, and both assumptions are usually discovered at the notario with days to closing.
...
## Ejido and informal title: ISR is not your only pro
...
## Worked scenarios (indicative: verify before relying on them)

These detailed calculations show how proper CFDI documentation versus missing invoices can change ISR liability by tens of thousands of dollars on the same property sale. The two scenarios use the same property and the same sale price, and differ only in whether the cost basis was documented. That difference is worth more than most buyers spend on professional advice across the entire hold.
...
<CtaBox
  title="Model the tax before you accept an offer"
  description="Send us the purchase deed and the price on the table, and we will come back with the likely ISR position, the cost basis you can actually prove and the withholding."
  buttonText="Ask for an introduction →"
  href="/contact/"
/>

## US and Canada tax treaty benefits: specific forms
...
The five questions below are worth asking before you buy rather than before you sell, and the quality of the answers tells you as much about the advisor as about the tax position. ISR is calculated and withheld by the notario at the moment of sale, which means every planning lever, ownership structure, residency position, CFDI discipline, exemption documentation, has to be in place years earlier. An advisor who defers with some version of "we'll figure it out at sale time" is describing a closing-day emergency, not a plan. Ask each in writing and keep the answers.
...
The three questions that matter: will I hold an RFC before the first payment, who issues the CFDIs on each cost, and what will the withholding be at sale under each method. An advisor who cannot answer all three at purchase will not have better answers later.
...
## Inflation adjustment and the documented cost stack
...
Inheritance changes the ISR position rather than removing it. A substitute beneficiary named in the trust deed takes the property without Mexican probate, but the cost basis and the CFDI file pass to them along with it, which means the documentation discipline a foreign owner keeps during their lifetime determines what their heirs pay on an eventual sale.
...
Three professionals touch your ISR position and only one of them controls the withholding. The notario calculates and withholds at closing but does not plan; the Mexican accountant projects and files but cannot override the notario; the US accountant claims the foreign tax credit afterwards and depends on both. Get the projection before you list rather than after you accept an offer, because by then the withholding method is effectively fixed.
