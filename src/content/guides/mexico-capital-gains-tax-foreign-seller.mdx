...
Underwriting the exemption as base case is the error this table exists to prevent. Mexican law exempts qualifying primary-residence gain up to 700,000 UDI, roughly $250,000 at 2026 unit values, but the tests are habitual residence, RFC tax residency and the absence of a prior exempt sale within the qualifying window. A US owner spending 4 months a year on site and renting the rest fails on habitual use regardless of intent. Model the exit fully taxable, and if a Mexican tax adviser later confirms the exemption applies, treat the saving as upside rather than as a return you already spent.
