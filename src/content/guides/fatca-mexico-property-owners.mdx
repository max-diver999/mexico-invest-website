...
readingTime: 12
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1788439494/more-group/mexico/guides/fatca-mexico-property-owners/hero.jpg"
heroAlt: "Stone frontage of the United States Embassy in Mexico City, its name in raised letters along the wall above the entrance"
relatedSlugs:
...
<CtaBox
  title="Does the property itself trigger a filing?"
  description="Send us how the asset is held and we will come back with whether it falls inside the reporting rules, which form applies, and what the threshold is for your situation."
