...
|---|---|---|
| Will you play 24+ rounds/year locally? | Yes | |
| Is net yield above 4.5% required? | | Yes |
| Hold period under 5 years? | | Yes |
| Need broadest resale buyer pool? | | Yes |
| Family uses club pool/dining without golf? | Yes | |
| Comfortable with club + HOA dual boards? | Yes | |
| Verified course financials provided? | Yes | Stop if no |
