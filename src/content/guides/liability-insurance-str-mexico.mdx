...
readingTime: 13
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1788403691/more-group/mexico/guides/liability-insurance-str-mexico/hero.jpg"
heroAlt: "Lit swimming pool, loungers and garden terrace of a small guesthouse at dusk in Cuernavaca"
relatedSlugs:
...
Airbnb's AirCover product, launched globally and available to Mexico-based hosts, provides two components relevant to this discussion: What it is not is liability insurance: platform protection covers damage to your property by guests within limits and stated exclusions, and does not respond to a guest injury claim against you personally.

Platform cover is a supplement rather than a policy and treating it as one is the common mistake. AirCover responds to guest-caused damage and certain liability claims arising through the platform, and it does nothing for a booking taken directly, for hurricane damage, for a claim outside its stated limits, or for an insurer voiding your policy because the short-term-rental use was never declared. Declare the use in writing, accept the $200 to $600 annual premium for STR liability, and read AirCover as a first layer above a real policy.
...
A defensible insurance structure for a Mexico STR property has four components: Property cover with a commercial-use endorsement, third-party liability sized for paying guests, loss of rents for repair downtime, and the HOA master policy checked for what it excludes. Missing any one of the four leaves a real exposure.
...
Foreign STR owners who directly employ cleaning staff, gardeners, or maintenance workers, rather than contracting through a [property management](/guides/property-management-riviera-maya-cost/) company, have Mexican labor law obligations and employer liability exposure. A property management company arrangement, where staff are employees of the management company, avoids this complexity at the owner level.
...
## HOA regime and STR restrictions: the insurance pre

Before investing in insurance, confirm your property is legally permitted to operate as an STR. HOA restrictions on short-term rental are both a legal and insurance issue. An insurer that discovers the rental was prohibited by the building has grounds to decline, so an unpermitted short-term rental is uninsured twice over, against the HOA and against the carrier.
...
<CtaBox
  title="What the policy excludes matters more here"
  description="Tell us the property and how you let it, and we will come back with an indicative premium and the exclusions that bite on a short-term let specifically."
...
Insurance is protection against loss; risk management reduces the probability of loss occurring. For STR operators in Mexico, proactive safety management has both liability and premium benefits. The measures that actually reduce claims are unglamorous: pool fencing and depth markings, working smoke and carbon monoxide detectors, non-slip surfaces, secure balcony railings, and a written house rules document guests acknowledge at booking.
...
These are indicative ranges as of mid-2026. Obtain current quotes for accurate budgeting. Budget $1,500-4,000 a year for the full stack on a coastal one-bedroom, with the hurricane deductible, a percentage of insured value rather than a fixed sum, being the number that determines what a claim actually pays.

Pricing the full stack gives a realistic annual figure rather than a range. On a $320,000 Riviera Maya condo let nightly, structure and contents cover at 0.4% to 0.8% of insured value runs $1,300 to $2,600, a named-storm endorsement is usually bundled with a 1% to 5% deductible, general liability at $300,000 to $1,000,000 adds $150 to $500, and short-term-rental liability adds $200 to $600. Expect $1,650 to $3,700 a year, which is 50 to 115 basis points of a 4.4% net yield.
...
Nine checks before binding cover, and the first is not about insurance at all: confirm the building actually permits nightly rental in writing. A policy written over a prohibited use gives the carrier grounds to decline exactly when you need it, which makes the HOA letter part of the insurance file rather than a separate piece of paperwork.
...
The line on this table that changes a decision is short-term-rental liability cover at $200 to $600 a year. It is small against an uncapped claim on undeclared rental use, which is the one exposure on this page that has no ceiling. Use the rest as underwriting stress inputs rather than quotes, and verify current bank, insurer and municipal figures before closing.
...
Premiums and coverage limits move with each renewal cycle; treat these bands as the stress case for your operating model and reconfirm quotes with two brokers before binding.

## Where short-term rental liability cover runs out

Umbrella limits and local caps interact in a way that surprises owners after a claim. Umbrella limits below $1 million USD left owners exposed when guest medical claims exceeded $250,000 MXN local caps. Premiums near $450 to $900/year rose 15% to 25% when pools lacked updated guardrail certificates. Operators who added 30-day minimum-stay clauses cut claim frequency but reduced gross occupancy 8 to 12 points versus nightly calendars.
