...
readingTime: 15
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1788435439/more-group/mexico/guides/wire-fraud-mexico-closing/hero.jpg"
heroAlt: "People crossing the plaza before Puebla's concrete state judiciary building"
relatedSlugs:
...
Understanding the normal closing flow helps you identify where fraud is most likely to appear. For a full overview of how Mexico property closings work, read [can foreigners buy property in Mexico](/guides/can-foreigners-buy-property-mexico/).
...
<CtaBox
  title="The email asking you to change accounts is the fraud"
  description="Tell us your closing timetable and we will come back with the verification protocol that prevents this, and who on the transaction should hold which detail."
