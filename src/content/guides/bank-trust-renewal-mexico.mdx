...
readingTime: 16
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/mexico/heroes/bank-trust-renewal-mexico-9660e448.webp"
heroAlt: "Puebla church seen through a wrought iron gate"
relatedSlugs:
...
![Ex convento de Maní](https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/mexico/guides/bank-trust-renewal-mexico/inline_1.webp)

![Ex Convento San Antonio De Padua](https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/mexico/guides/bank-trust-renewal-mexico/inline_2.webp)
...
Renewal is cheaper than establishment and that surprises owners who expected to repurchase. Against an original setup of $2,500 to $4,000, renewal is bank-quoted at roughly $500 to $2,500, and the annual fee continues unchanged at $500 to $800 through the new 50-year term. Nothing reverts to the bank, no new SRE permit is generally required for a standard residential renewal, and the property is not revalued. The transaction is an administrative extension of an existing instrument, which is why the fee sits closer to a beneficiary change than to a new trust.
...
Remaining term is a price variable on a resale and buyers rarely negotiate it. A trust constituted in 2005 has roughly 29 years left in 2026, which is comfortable; one from 1990 has about 14 and will need renewal inside your likely hold, at $500 to $2,500 plus the coordination. Under 25 years justifies asking the seller to absorb the renewal or discount accordingly; under 10 years should be a written closing condition with the bank engaged before funds move. Ask for the trust's constitution date in the first document request.
...
Substitution is faster and cheaper, [can foreigners buy property in Mexico](/guides/can-foreigners-buy-property-mexico/).
...
<CtaBox
  title="Renewal is routine until it is not"
  description="Send us the trust deed and its dates, and we will come back with what renewal involves, what it costs, and what happens if the term has been allowed to lapse."
...
Four documents to file the day renewal completes, because they are needed twice, once at the next renewal and once at sale. The renewed trust instrument, the bank's confirmation of the new term, the receipt for the renewal fee, and an updated schedule of beneficiaries including any substitute designation.
...
### How trust fees relate to your other holding costs
...
Five questions for an estate attorney working across both jurisdictions, and they need asking together rather than separately. Does the substitute beneficiary designation in the Mexican trust align with the will at home; what happens if a named beneficiary predeceases you; does the trust term outlast your intended holding period; how does the property pass if all beneficiaries die simultaneously; and what does the trustee bank require from an heir to effect the transfer.
...
### Trust term remaining and pricing negotiation scrip
...
Selling near renewal window, complete renewal first or assign with clear fee allocation in contract. Buyers fear short remaining term; sellers who renew pre-listing often recover fee in sale price. The practical rule: a buyer discounts a short remaining term more than the renewal actually costs, so a seller within a few years of expiry is usually better off renewing first and pricing the certainty in.
...
Fideicomiso renewal is administrative, not repurchase. Calendar annual fees, name substitute beneficiaries, verify remaining term on resale, and file renewal confirmations. Fear of year fifty should never block a lawful 2026 purchase. The framing that saves people money: renewal is an administrative extension of an existing trust, not a repurchase of the property. It does not reset your cost basis, does not trigger tax, and does not require the property to be revalued.

Pair with [Fideicomiso Mexico Explained](/guides/fideicomiso-mexico-explained/) for setup mechanics and [Buy Property Foreigner](/guides/can-foreigners-buy-property-mexico/) for first purchase sequence.
