---
title: "Property Taxes in Mexico vs the US: 2026 Guide"
description: "What property tax actually costs in Mexico compared with the United States: predial, ISAI at purchase, rental income tax, and ISR when you sell."
pubDate: 2026-06-07
...
![Merida que hacer](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460822/more-group/mexico/guides/mexico-property-taxes-explained/inline_1.jpg)
...
Predial is the one Mexican property cost that is unambiguously cheaper than its US equivalent, and the gap is large. A Riviera Maya 1BR pays $200 to $600 a year against $2,000 to $8,000 on comparable US coastal property, a saving of $1,800 to $7,400 annually that partly offsets the fideicomiso and the higher management fees. The rule that matters at closing is that arrears attach to the property rather than to the person who incurred them, so a seller must show a current receipt before funds move.
...
Registering an RFC before the first booking is the decision that sets your Mexican tax rate for the whole year. Without one, platforms withhold ISR at the higher non-registered default and there is no route to recover the difference; with one, you can elect to be taxed on net rental income after management, HOA, predial and depreciation. On a Playa unit grossing $21,000, that election is the difference between roughly $5,250 withheld on gross and a far smaller figure assessed on net. The election is not retroactive.
...
At the notario a non-resident seller chooses between two methods, and the choice is worth more than most of the operating decisions across the whole hold: 25% of the gross sale price with no deductions, or 35% of the documented gain with an RFC and a Mexican legal representative appointed before closing. On a modestly appreciated property the gross method is frequently the larger bill.
...
Corporate ownership replaces the non-resident withholding regime with a corporate tax return, monthly accounting, a legal representative and, for a US owner, Form 5471. On a single residential property that is cost without benefit; the structure earns its keep on commercial assets or a genuine portfolio.
...
The change that matters is that platforms now withhold at source and report host income directly to SAT, so an unregistered owner is no longer invisible, only unreconciled, and the mismatch is what triggers a review. Municipal registration data is increasingly cross-checked against it.
...
Mexican tax law includes primary residence capital gains relief for qualifying sellers, foreign vacation owners usually do not qualify on STR-dominant condos. Do not underwrite exit assuming exemption. And the qualifying test is documentary rather than intentional: Mexican tax residency, an RFC, and utility bills or bank statements in your name at that address. A property let nightly for most of the year fails it regardless of how long you held it.
...
## Worked hold-period tax cash flow (illustrative)
