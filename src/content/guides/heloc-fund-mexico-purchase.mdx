...
readingTime: 13
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1788435433/more-group/mexico/guides/heloc-fund-mexico-purchase/hero.jpg"
heroAlt: "Aerial view of a suburban housing subdivision in Colorado Springs, Colorado"
relatedSlugs:
...
The HELOC route to Mexico real estate is popular precisely because it eliminates so many complications: no Mexican bank application, no fideicomiso-lien coordination, no cross-border [mortgage](/guides/non-resident-mortgage-mexico/) documentation, no peso currency risk on financing costs. You borrow against something you already own, wire dollars, and close.
...
See the complete purchase sequence: [can foreigners buy property in Mexico](/guides/can-foreigners-buy-property-mexico/).
...
HELOC capacity is determined by your US lender using combined loan-to-value (CLTV) calculation. Most US lenders allow up to 80–85% CLTV, subtracting your existing first mortgage balance from the available equity. The practical consequence: a US home with substantial equity can fund a Mexican purchase outright, which preserves the cash-buyer position at the Mexican closing table and the 5–10% discount that comes with it, while pricing the debt at US rather than Mexican rates.
...
HELOC economics are significantly more favorable than cross-border Mexico mortgages for most US homeowners, though rates have risen substantially from 2021 lows. The comparison that matters is against the alternative, not against 2021: a HELOC in the high single digits sits well below Mexican non-resident lending, where the average fixed peso mortgage rate has held near 11.45%, and it does not require a Mexican bank to accept a lien over a trust beneficial interest.

Negative carry is the test this table exists to run, and it fails more often than buyers expect. A Mexican condo netting 4.4% funded by a HELOC at 9% costs 460 basis points of carry every year the structure is in place, roughly $14,000 annually on a $310,000 draw. Appreciation has to cover that before the trade breaks even, and Mexican national appreciation is currently tracking 5% to 7%. The structure works for buyers who expect to repay the draw quickly, and it works poorly as long-term leverage.
...
| Mexican bank mortgage (peso) | 11–14% | Currency risk for USD buyers |
...
This is the most important section for any HELOC buyer to fully internalize before drawing. The risk that gets underweighted: a HELOC is secured against your home, so a Mexican property that underperforms does not threaten the Mexican property; it threatens the house you live in. That is a different risk profile from a mortgage secured on the asset itself.
...
The tax analysis is less favorable than many buyers assume. Understanding this before drawing prevents unpleasant surprises at tax filing. Since the 2017 rules, home-equity interest is only deductible where the proceeds improve the securing residence, which funding a Mexican purchase does not. Whether it becomes deductible investment interest instead depends on tracing the use of funds, and that requires records kept from the draw date.
...
Timing matters both for minimizing interest cost and for managing Mexico transaction requirements. Draw late rather than early: interest accrues from the day funds leave, and a Mexican closing runs 45 to 90 days with a trust permit that can slip. Drawing at contract signature rather than at closing can add a month or two of interest to nothing.
...
Currency exposure runs the right way in this structure, which is one of its genuine advantages. The HELOC is a dollar obligation and Riviera Maya and Los Cabos contracts are written in dollars, so a peso move does not change either the debt or the asset value, only the peso-denominated operating costs, perhaps 20% to 30% of the cost base. Compare that with a peso mortgage against dollar income, where a 10% peso strengthening raises the monthly payment 10% with no change in the property, a 20,000 peso payment moving from $1,000 to $1,176 as the rate goes from 20 to 17.
