...
Industrial and coastal residential are not two versions of the same trade, and for most readers of this guide only one of them is actually accessible. The four profiles below sort which applies.
