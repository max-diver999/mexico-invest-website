...
readingTime: 18
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1788439494/more-group/mexico/guides/currency-risk-mexico-property-usd/hero.jpg"
heroAlt: "Straight-on view of the stone facade of the Guardiola building, part of Banco de México, in central Mexico City"
relatedSlugs:
...
<CtaBox
  title="Dollar income against peso costs, or the reverse"
  description="Send us your income currency and the property's cost base, and we will come back with where the exposure actually sits and what it does across a holding period."
