...
<CtaBox
  title="Where a Mexican closing actually loses time"
  description="Send us the transaction and we will come back with a realistic schedule, the steps that historically slip, and what can be started in parallel."
