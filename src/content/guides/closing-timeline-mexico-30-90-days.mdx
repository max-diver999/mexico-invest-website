...
Parallel versus sequential is what decides where inside that range you land. Due diligence runs days 10 to 30 and fideicomiso setup days 10 to 40, and those two overlap: bank KYC and the SRE permit can proceed while your attorney works the registry search and HOA documents. Run them sequentially instead and the same transaction stretches past 90 days. The binding constraint is usually the bank's identification of you personally, which no attorney, power of attorney or fee can accelerate, so start that file the week the contract is signed.
...
## Phase 2: due diligence (days 10–30, running in parallel)

Due diligence begins immediately after contract signing and must complete before you release additional funds. Critical for foreign buyers is running this parallel with fideicomiso bank setup, not sequentially. Four documents carry the risk: the certificado de libertad de gravamen showing liens as of that week, the escritura chain, the condominium regime's rental clause, and 24 months of HOA statements with the reserve balance. Order all four through your own attorney at $1,500 to $5,000 rather than accepting copies from the seller, and run them in parallel with the bank's trust file so neither becomes the critical path.
...
## Phase 3: fideicomiso setup (days 10–40, in parallel)
...
Trust setup has three steps with different owners and only one of them is yours. Bank application and KYC take 1 to 2 weeks and depend on documents only you can supply; SRE permit processing takes 1 to 3 weeks and sits with the foreign ministry; the trust fee of $2,500 to $4,000 falls due at constitution. Chase the first, wait on the second, and budget the third. A buyer who submits a complete bank file in week one rarely finds the trust on the critical path; one who waits until due diligence clears adds 2 to 4 weeks to the closing.
...
## Phase 6: public registry filing (days 75–120, post-closing)
...
Two lines in this table are decisions rather than fixed costs, and both are worth attention. Independent legal review at $1,500 to $5,000 is the only item paid to protect your interest specifically, and it must happen before any deposit rather than at closing. Short-term-rental management at 20% to 35% of gross is the largest ongoing expense on the property and the one most negotiable at the outset. Everything else — ISAI at 2% to 4%, the fideicomiso, the annual trust fee — is a tariff you pay rather than a choice you make. Here the benchmark that matters is the 45 to 90 day range itself, and whether the trust file runs in parallel with due diligence or after it.
...
Every range above compresses or stretches with bank workload and municipal queues — plan your funds availability against the slow end, and reconfirm each checkpoint as it approaches.
