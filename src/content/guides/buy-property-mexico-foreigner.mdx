...
![Gallery Over Bg Ocean](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460733/more-group/mexico/guides/buy-property-mexico-foreigner/inline_1.png)

![Hidden Beach Au Naturel1](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460734/more-group/mexico/guides/buy-property-mexico-foreigner/inline_2.jpg)
...
Four roles matter and only one of them works for you. The notario is a state-appointed officer with public faith who is neutral between the parties; the seller's agent represents the seller; the bank trustee represents the bank. Your independent attorney at $1,500 to $5,000 is the only party in the transaction contractually obliged to protect your interest, and hiring one before the first offer rather than after due diligence is what makes the rest of the team's neutrality safe to rely on. On a $320,000 purchase that fee is roughly 0.5% to 1.5% of price.
...
The honest answer is a number the listing never shows you. Take a real Playa del Carmen case: a USD 285,000 two-bedroom in an established rental building, bought by a US citizen through a new Scotiabank fideicomiso, closing in about 55 days from first attorney call to escritura. Layer the costs in the order they actually hit the bank account — USD 500 attorney retainer, USD 2,500 for due diligence, USD 3,200 to establish the trust, USD 7,100 in acquisition tax and notario fees — and the acquisition basis lands at roughly USD 302,800, or 6.2% above the price on the sign. That 6.2% is the number your yield math has to divide by.
...
The closing is the easy part; the ninety days after it decide whether the property runs itself or generates a permanent administrative tail. Six items carry real deadlines. Beneficiary confirmation with the trust bank should be done inside the first week, because a name error on the fideicomiso is trivial to fix now and expensive to fix at resale. Predial registration follows inside two weeks — municipalities in Quintana Roo and Baja California Sur discount the annual bill by 10-20% for payment in January, and you cannot claim that discount from an account that does not exist. Utilities in the beneficiary's name, a signed manager contract, municipal lodging registration where the state requires it, and a CPA briefed on foreign rental reporting fill out the rest of the quarter.
...
Property location determines ownership structure: fideicomiso bank trust for restricted zone purchases, direct title for properties measured beyond the constitutional 50 km and 100 km limits. Over 95% of foreign-targeted inventory requires fideicomiso due to coastal location preferences. In practice the answer is yes for almost everyone reading this, because the markets foreign buyers actually want are the coastal ones. The useful question is therefore not whether you need a trust but what it costs — $2,500–$4,000 to establish and $500–$800 a year — and whether an inland alternative such as Mérida or San Miguel de Allende serves your brief well enough to avoid it.
...
Outside the zone, San Miguel de Allende, Guadalajara, Querétaro and Mexico City, direct title for foreigners is possible without a bank trust. Mérida is the common exception to the inland assumption: its urban core sits roughly 35 km from the Gulf and inside the band.
...
This article covers the foreign-buyer sequence end-to-end. For a parallel checklist format with timeline graphics, see [How to Buy Mexico Property Step by Step](/guides/how-to-buy-mexico-property-step-by-step/). The two formats serve different moments. Read this page while you are deciding whether and where to buy; use the step-by-step checklist once you have a property under discussion and need to track SRE permit, appraisal, trust constitution and notario scheduling against a 45–90 day calendar.
...
Identify which of the three profiles below you are before working the steps, because the timeline and the cost differ substantially between them. The coastal buyer runs the full sequence; the inland buyer drops the trust and the SRE permit entirely, saving both the $2,500–$4,000 setup and several weeks of calendar; the entity buyer adds apostilles and certified translations that routinely extend a closing by a month.

**The coastal buyer.** Everything in this guide applies in full: restricted zone, fideicomiso, SRE permit, notario closing. Budget 45–90 days and 5–10% in closing costs.

**The inland buyer.** San Miguel de Allende, Guadalajara, Querétaro and Mexico City sit outside the restricted zone, so the trust steps drop away entirely — direct title, no annual fee, a shorter timeline and a smaller closing stack.

**The corporate or entity buyer.** A Mexican company, a US LLC or a trust adds documentation at every step, needs apostilles and certified translations, and requires confirming in advance that the specific notario will accept the structure. Allow several extra weeks and expect the paperwork rather than the law to be the constraint.
