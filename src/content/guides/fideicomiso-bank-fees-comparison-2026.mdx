...
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/mexico/guides/fideicomiso-bank-fees-comparison-2026/hero.webp"
heroAlt: "Torre BBVA on Paseo de la Reforma, Mexico City"
category: "guides"
...
| SRE permit (MXN 21,650 federal duty) | $1,200 to $1,700 | Included or billed separately |
...
Scotiabank, BBVA, and Banorte usually fall inside the same broad setup range: $2,500 to $4,000 for a new fideicomiso. On foreign buyer familiarity Scotiabank often wins, BBVA can be efficient where the local notario has a direct channel, and Banorte may be practical when the market already uses it heavily.
...
- Inclusion of the first annual trustee fee in setup.
- Whether IVA applies to any bank service line.
- Which currency annual fees are charged in: USD, MXN, or bank-converted equivalent.
- Support for foreign wire payment without a Mexican account.
- Whether beneficiary substitution is priced separately on resale.
- A named trust officer for post-closing service, if the bank has one.

For the legal reason foreigners use this structure in the first place, see [can foreigners buy property in Mexico](/guides/can-foreigners-buy-property-mexico/).
...
Annual fees differ less between banks than buyers hope, and the spread rarely justifies choosing a trustee on price alone. The market band sits at $500 to $800 a year across the major fiduciarios, so the difference over a ten-year hold is perhaps $3,000, meaningful but smaller than a single year of HOA on most coastal condos. What varies more is service: how quickly a beneficiary substitution is processed at $800 to $1,500, whether English-language documentation is available, and how the bank handles renewal notices, which are due 18 months before a 50-year term expires.
...
Renewal is quoted rather than tariffed, which is why it belongs in the comparison at setup rather than in year 49. Expect roughly 50% to 75% of the original establishment cost, or about $1,250 to $3,000 in today's terms, and ask each bank to state its renewal basis in writing before you constitute the trust. Almost no original buyer reaches year 50, the trust transfers on sale or passes to substitute beneficiaries first, but the quote tells you how the bank treats fees it is not required to publish.
...
<CtaBox
  title="Get the fee schedule in writing before you choose"
  description="Send us the property and the bank being proposed, and we will come back with an indicative schedule for setup, annual administration, amendment and cancellation."
...
| SRE permit line | Included or $1,200-1,700 | Usually not new on renewal, verify |
...
- [ ] Check whether a new trust or existing trust assumption is planned.
