---
title: "Gross vs Net Rental Yield in Mexico: Real Numbers 2026"
...
Two differences separate these formulas and both work against the headline number. The numerator changes because every operating cost comes out, management at 20% to 35%, HOA, predial, the fideicomiso fee, vacancy and lodging tax. The denominator changes because all-in cost includes closing at 5% to 10%, and furnishing where the unit is let nightly. On a $310,000 Playa condo, that is a 5.5% to 7% gross across a full year against a 4.3% to 4.5% net in prime colonias, and $326,000 of basis against $310,000 of price, which is why a deck quoting 8% or a nightly model projecting more both overstate what reaches your account.
...
![Hotel mousai](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460764/more-group/mexico/guides/gross-vs-net-yield-mexico/inline_1.webp)

![Barcelo Maya Grand Resort](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460764/more-group/mexico/guides/gross-vs-net-yield-mexico/inline_2.jpg)
...
Sensitivity is where a pro forma either survives or fails, and two inputs dominate. On $300,000 with $21,000 of gross, moving management from 20% to 30% costs $2,100, and moving the HOA from $300 to $600 a month costs $3,600, together $5,700, or 190 basis points of net yield on the same property and the same rent. Neither input is visible in the listing price. Get the actual management quote and 24 months of HOA statements before you agree a number, because they matter more here than the purchase price does.
...
Comparing Mexican net against a foreign gross is the error that makes bad purchases look reasonable. A US rental quoted at 6% is usually stated before management, vacancy and maintenance, exactly as a Mexican 6.6% gross is; the Mexican figure becomes 4.4% net and the US one falls too. Restate both on the same basis, after every operating cost, on all-in acquisition price rather than sticker, and the honest comparison is usually a narrower gap than either marketing claim suggests, often 50 to 150 basis points rather than the several points the headline numbers imply.
...
Pacific-coast net yields compress harder than Riviera Maya equivalents, and two worked cases show where the money actually goes. A branded Los Cabos unit at USD 450,000 all-in grossing USD 27,000 gives up 30% to management and USD 9,600 a year to the HOA, leaving NOI around USD 9,300, roughly 2.1% net, which only works if appreciation carries the thesis. A Puerto Vallarta Centro property at USD 340,000 all-in grossing USD 19,000 loses 25% to management and USD 4,200 to the HOA, netting about USD 10,000 or 2.9%. Both markets trade net yield for stability rather than matching Playa's arithmetic:
...
## Who most needs this distinction

**The first-time foreign buyer.** This is the single most expensive misunderstanding available in Mexican property: a 6.6% gross quote and a 4.4% net outcome are the same property, and buyers who model the first are systematically disappointed by the second.

**The buyer comparing markets.** Gross yields across Mexican markets are close enough to be uninformative; net yields separate them by a full percentage point or more, because HOA and management rates differ far more than rents do.

**The owner already holding.** Recalculating net annually against actual statements, rather than against the pro forma from purchase, is what catches HOA drift and management underperformance while there is still time to act.
