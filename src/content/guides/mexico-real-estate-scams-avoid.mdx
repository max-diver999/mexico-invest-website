...
readingTime: 18
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1788439495/more-group/mexico/guides/mexico-real-estate-scams-avoid/hero.jpg"
heroAlt: "The deep red modernist block of Mexico's Registro Agrario Nacional under a clear sky, palms and passers-by along its fence"
relatedSlugs:
...
Ownership mechanics: [Fideicomiso Mexico Explained](/guides/fideicomiso-mexico-explained/). Purchase steps: [can foreigners buy property in Mexico](/guides/can-foreigners-buy-property-mexico/).
...
<CtaBox
  title="Most of these are visible before you pay"
  description="Send us the transaction as it stands and we will tell you which known patterns it currently resembles and which document would settle each one."
