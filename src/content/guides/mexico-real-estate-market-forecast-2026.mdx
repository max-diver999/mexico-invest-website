...
---
<TldrBlock text="Our 2026 outlook: national price growth moderates from 2025's peaks while coastal dispersion widens — Quintana Roo's +14.68% in 2025 will not repeat corridor-wide, oversupplied Tulum sub-markets flatten first, and Playa Centro, Mérida and Puerto Vallarta hold firmest. Rates, peso strength and STR regulation are the three variables that decide which scenario lands." />
...
Mexican property in 2026 is not one market moving together. Coastal states grew fastest in 2025 — Quintana Roo at +14.68% and Nayarit at +12.52% — while Mérida compounded more slowly at +9.4% and generic resale in oversupplied corridors fell. Foreign buyers account for roughly 40,000 purchases a year, about a tenth of all transactions, with Americans making up around 65% of that, which means North American demand and the dollar drive coastal pricing more than Mexican wages do. Any forecast that quotes a single national figure is averaging across markets that are moving in opposite directions.
...
Five regions, three distinct drivers. The Yucatán and Jalisco are growing on inbound migration and services; Quintana Roo on tourism and nomad demand, with the [Riviera Maya](/guides/riviera-maya-property-investment-guide/) corridor absorbing a delivery wave; Nuevo León on nearshoring manufacturing, which is the only one of the five where the demand is industrial rather than residential. Mexico City sits apart, driven by domestic capital and immune to most of what moves the coasts.
...
The three segments diverge. Residential entry product in liquid markets holds up because the buyer pool is deep. Vacation rental performance is bifurcating along supply lines rather than along quality — see [short-term rental occupancy by month](/guides/str-occupancy-by-month-riviera-maya/) for what that looks like in practice. Commercial and industrial is the segment with genuine structural tailwind from nearshoring, and the segment least accessible to an individual foreign buyer.
...
Emerging-market forecasts are the least reliable part of any outlook, and the reason is visible in Tulum: the same characteristics that make a market look like early-stage upside — thin inventory, rising visibility, low prices — also describe a market that cannot absorb the supply its own popularity attracts. Treat growth forecasts for frontier markets as a reason to visit rather than a reason to buy, and check the [best-areas ranking](/guides/best-areas-invest-mexico-2026/) for what is currently established.
...
Three categories of risk sit underneath every number here. Market risk is oversupply, and it is already realised in parts of Tulum. Regulatory risk is short-term rental registration and enforcement, tightening across Quintana Roo and spreading — see the [Riviera Maya STR rules](/guides/short-term-rental-rules-riviera-maya/). Environmental risk is hurricane frequency and, on the Caribbean side, sargassum, both of which affect insurance cost and guest reviews before they affect prices.

Three risks would move the 2026 numbers and they are not the ones headlines emphasise. Supply is first: Tulum's Region 15 overhang is still clearing past 74 days on market, and further completions extend that. Regulatory enforcement is second: Quintana Roo's short-term-rental registration cycle can interrupt a calendar administratively rather than economically. Currency is third but limited for dollar buyers, since Riviera Maya and Los Cabos contracts are dollar-denominated and only 20% to 30% of the cost base sits in pesos. National appreciation tracking 5% to 7% is the base case those three risks would move.
...
Infrastructure moves markets on a decade horizon, not an annual one. The Tren Maya and the Tulum airport improve corridor access without repairing individual unit economics; road and airport capacity upgrades on the Pacific matter more for Puerto Vallarta and Los Cabos than any local development does. The pattern worth watching is that new access consistently raises land values ahead of rental yields, which favours holders over new buyers.
...
Mexican lending to non-residents remains expensive at 9–14% and unlikely to change materially in 2026, which keeps the foreign market roughly 70% cash — see the [non-resident mortgage guide](/guides/non-resident-mortgage-mexico/). That structural fact is why Mexican coastal property responds to US rates and US equity prices rather than to Banxico: the buyers are funding from home.
...
Underneath the annual noise, three trends run in the same direction: North American retirement and remote-work migration continues, coastal supply is constrained by environmental regulation in the places worth owning, and short-term rental regulation keeps formalising. The combination favours legal, well-located, compliant inventory over cheap fringe product — which is a slower conclusion than most forecasts offer and a more reliable one.
...
## What the forecast means for each buyer type

The same outlook reads differently by buyer. Retirees should weight healthcare access and climate over price trajectory, since a twenty-year hold outlasts any forecast here — start with the [retirement guide](/guides/mexico-real-estate-for-retirees/). Nomads should weight connectivity and rental permission. Investors should weight supply: in 2026 the difference between a good and a bad outcome in Mexican property is mostly a question of how many identical units are competing with yours.
