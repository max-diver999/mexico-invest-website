...
readingTime: 13
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1788435436/more-group/mexico/guides/seller-financing-mexico/hero.jpg"
heroAlt: "Tiled red and white colonial facade of the Palacio de Justicia, Puebla"
relatedSlugs:
...
The seller retains legal title (and [fideicomiso](/guides/fideicomiso-mexico-explained/) beneficial interest in restricted zones) until the buyer completes all payments. Upon final payment, the escritura transfers to the buyer. This mirrors a conditional sale in US law.
...
Full ownership (escritura + fideicomiso) transfers to the buyer at closing. The seller holds a [mortgage](/guides/non-resident-mortgage-mexico/) lien (hipoteca) registered on the fideicomiso securing the unpaid balance.
...
Seller financing is not typical in Playa del Carmen's active resale condo market where cash buyers are abundant. It tends to appear in specific circumstances that create seller motivation and buyer opportunity. In an active cash market a seller has no reason to finance, so its presence is information: an unusual property, a stalled listing, a seller with a tax reason to spread the gain, or a title complication that makes a conventional sale awkward. Find out which before treating the terms as generous.
...
The quality of the seller finance contract determines your protection in every scenario, from a routine payoff to a seller death, bankruptcy, or dispute. Independent attorney review is mandatory, not optional. The clauses that matter are the ones covering what happens when things go wrong: seller death or bankruptcy, an existing mortgage on the property, default remedies on both sides, and exactly when and how title transfers to you.
...
All standard Mexico property due diligence applies, title chain, ejido screening, HOA review, STR status. Seller-financed deals require additional seller-specific investigations because the seller is now also your lender. Two additional checks: whether the seller actually owns the property free of encumbrance, and whether an existing mortgage on it would survive the arrangement. A seller financing a property they have mortgaged is offering you their lender's collateral.
...
Independent escrow plays an important role in seller-financed purchases, particularly when title is being retained or when the seller has an existing mortgage. Where title is retained until final payment, escrow is what prevents a seller from selling the same property twice or encumbering it while you are paying. It is more important here than in a conventional purchase, not less.
...
Seller financing rates are negotiated between parties and reflect seller motivation, market rates, and perceived buyer risk. Understanding the economics helps position negotiation. The benchmark is what you would otherwise pay: a US home-equity draw at domestic rates, or a Mexican bank at 9–14%. Seller financing above the second number is worse than the market alternative and should be negotiated as such.

Benchmarking against the real alternative is what keeps a seller-financed rate honest. A Mexican bank lending to a non-resident prices around 11%, and a US home-equity draw typically runs 7% to 9%, so a seller note at 6% to 8% on $300,000 is genuinely competitive while one at 10% is worse than borrowing at home and wiring cash. Trading full asking price for a lower rate is usually the better deal for a buyer: on a $300,000 note, two points of rate is $6,000 a year, which outweighs a 3% price concession within two years.
...
Seller financing affects your tax position in ways that all-cash purchases do not, both in Mexico and in your home country. For the seller it usually spreads the ISR liability across years; for you it may change when and how your cost basis is documented, which is what determines your own ISR bill on the eventual sale.

Documentation timing is where seller financing quietly damages a buyer's position. Your Mexican cost basis is built from CFDI invoices, and in an instalment structure the escritura may record a value that does not match what you eventually pay, or payments may be made over years without invoices attached. A $300,000 purchase documented at $180,000 leaves $120,000 outside your basis, which at the 35% net method costs roughly $42,000 of extra ISR when you sell. Have a Mexican CPA structure the invoicing before the first payment, not at the last.
...
Seller financing adds a counterparty to a transaction that would otherwise end at closing, so the checklist covers the person as well as the property: their title position, any existing mortgage, what happens on their death or insolvency, and exactly when the deed transfers into your name.
...
Seller financing works when both sides want something the open market will not give them, and the three profiles below are the situations where that overlap actually exists. A cash-flow investor pays full asking price on an extended-market Playa resale in exchange for a five-year carry at 7%, taking title at signing and starting rental operations immediately, the seller gets certainty and price, the buyer gets time. A relocating retiree with USD 120,000 against a USD 320,000 property is buying access to a purchase that no conventional lender would fund. Each case has a different failure mode.
