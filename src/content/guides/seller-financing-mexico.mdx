...
Seller financing adds a counterparty to a transaction that would otherwise end at closing, so the checklist covers not just the property but the person: their title position, any existing mortgage, what happens on their death or insolvency, and exactly when the deed transfers into your name.
