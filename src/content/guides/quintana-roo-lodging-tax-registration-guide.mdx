...
Tulum municipal offices may move slower than Playa during peak season. Start registration before high-season bookings if you self-manage. Yield context: [Tulum](/areas/tulum/) and colonia data in [Airbnb Investment Mexico Guide](/guides/airbnb-investment-mexico-guide/).
...
<CtaBox
  title="Registration is separate from the condominium rules"
  description="Tell us the property and we will come back with the state registration steps, the current lodging tax position and what the building's own rules permit."
