...
---
<TldrBlock text="Retiring to Mexican property works best when the location is chosen for services rather than scenery: established expat healthcare, direct flights home, and a community you can join. Lake Chapala and Mérida offer direct title inland; coastal favourites like Puerto Vallarta need a fideicomiso. Budget the full carry — HOA, predial, trust fee, healthcare — not just the purchase." />

import TldrBlock from '../../components/TldrBlock.astro';
import FaqBlock from '../../components/FaqBlock.astro';
import CtaBox from '../../components/CtaBox.astro';

TL;DR: Mexico offers retirees affordable, high-quality properties with excellent healthcare, favorable climate, and significant cost savings. The average retirement home costs $200,000-400,000, with living expenses 40-60% lower than the US. Popular areas include [Lake Chapala](/guides/lake-chapala-real-estate-americans/) ($330,000 average), Puerto Vallarta, and [Mérida](/areas/merida/).
...
Three things bring North American retirees to Mexico and they compound: total living costs 40–60% below a comparable US city, private healthcare at roughly a third of US prices, and a choice of climates from temperate highland to tropical coast. On a $3,300 US monthly budget the equivalent Mexican life costs about $1,380, and the saving is concentrated in housing, healthcare and food rather than spread thinly across everything. More than 1.5 million US citizens now live in Mexico, which is why the expat infrastructure — English-speaking doctors, bilingual notarios, established communities — already exists in every market covered here.
...
## The four established retiree markets

Four markets hold the large majority of North American retirees, and they differ mainly on climate and price. Lake Chapala averages about $330,000 and offers a 65–80°F highland year-round with the densest expat community in the country. [Puerto Vallarta](/guides/puerto-vallarta-property-investment-guide/) runs $300,000–450,000 for a coastal condo with the best private healthcare on the Pacific. Mérida sits near $165,000, inside the coastal band on the measured test and so on the same fideicomiso as the beach markets. San Miguel de Allende trades affordability for colonial architecture and a cultural calendar. Choose on climate first: it is the variable retirees most often get wrong and cannot change afterwards.

### Lake Chapala and Ajijic: the retiree capital
...
## Ownership structures and paperwork

Where you buy decides how you own. Inside the restricted zone — 50 km from any coast, 100 km from a border — a foreigner holds property through a [fideicomiso](/guides/fideicomiso-mexico-explained/) costing $2,500–4,000 to constitute and $500–800 a year. Outside it, in [Mérida](/areas/merida/), [Lake Chapala](/guides/lake-chapala-real-estate-americans/) or San Miguel de Allende, your name goes directly on the escritura with no trust and no annual fee. That is a $15,000–25,000 difference over a twenty-year retirement, and it is the single strongest financial argument for the inland markets.
...
## Property types for a retirement purchase

Three formats, and the choice is really about how much maintenance you want to be responsible for at 75 rather than at 65. A condominium hands grounds, security and pool to an HOA for $100–500 a month. A single-family home gives space and privacy and makes you the maintenance department. A turnkey property costs a premium of roughly 10–15% and removes the renovation project entirely — which for a buyer relocating from abroad without local contractors is frequently worth paying.
...
## Healthcare: the decisive variable

Medicare does not travel, so healthcare is the line that decides where a retiree can realistically live. Private Mexican care costs roughly 20–40% of US prices and the major retiree markets all have private hospitals with US- or EU-trained specialists — but complex or emergency care outside those markets means a transfer. Budget $150 a month for routine care and private insurance, verify what your condition requires before choosing a location, and treat proximity to a private hospital as a hard constraint rather than a preference.
...
## What it actually costs to buy and hold

Budget the purchase price plus 5–10% to close, and then roughly 1.5–2% of value a year to hold. On a $300,000 property that is $15,000–30,000 at closing and $4,500–6,000 annually in HOA, predial, insurance and trust fees. The currency dimension matters more for retirees than for investors: a dollar pension against peso costs means a strong dollar raises your standard of living and a weak one lowers it, with no rental income to hedge against the move.
...
Retiring to Mexico ends no US tax obligation. US citizens file on worldwide income wherever they live; any rental income goes on [Schedule E](/guides/us-taxes-mexico-rental-property/); Mexican bank accounts above $10,000 trigger FBAR reporting; and ISR is withheld when you eventually sell the property. Mexico taxes rental income and capital gains on its own account, with foreign tax credits preventing double taxation only where the Mexican filings actually exist. Engage a cross-border CPA before the move, not at the first April afterwards.
...
## Infrastructure: internet, transport, banking

The three services that determine whether daily life works are unevenly distributed. Fibre internet is reliable in Mérida, Lake Chapala and central Puerto Vallarta and patchy on the fringes of all three. Domestic flights and toll roads are good between major cities and thin elsewhere, which matters for family visits. Mexican banking is straightforward to open with residency and awkward without it — most retirees keep US accounts and spend by card, which is workable but carries FX cost on every transaction.
...
Security in Mexico is neighbourhood-specific rather than national, and the established retiree markets have crime profiles closer to a mid-sized US city than to the national headline figures. What actually protects retirees is ordinary: choosing a neighbourhood on local advice rather than price, using vetted service providers, gated or monitored housing where the community expects it, and a hurricane or emergency plan on the coasts. Treat the national statistic as noise and the local one as the answer.
...
The retirees who stay are the ones who build a local life, and the data on who leaves is consistent: isolation ends more Mexican retirements than money does. Established expat communities in Lake Chapala, San Miguel and Puerto Vallarta give you an English-speaking landing pad, and functional Spanish is what converts that into a life beyond it — enough to deal with a cleaner, a plumber and eventually an HOA assembly without a translator.

### Expat Communities and Social Networks

Lake Chapala Society (LCS): the benchmark expat organization — thousands of US and Canadian members, dozens of interest groups, Spanish classes and volunteer programs. The depth of that infrastructure is a large part of why Chapala works for a first international retirement; the full picture is in [Lake Chapala Real Estate for Americans](/guides/lake-chapala-real-estate-americans/).
...
## Snowbird and part-year strategies

Not every retiree moves permanently, and part-year ownership changes the arithmetic in two ways. Rental income from the months you are away offsets carrying costs, which turns a $6,000 annual holding cost into a much smaller one — and it puts you into the permit and tax stack that full-time residents avoid entirely. Domicile is the other half: where you are tax-resident is decided by days and intent, not by which property you own.
...
Retirement purchases fail on the same checks as investment purchases, with one addition: you will be living in the result. Verify the [title chain and the ejido question](/guides/due-diligence-mexico-real-estate/), the HOA financials and any pending assessment, and the physical fabric of the building — then verify the things a spreadsheet does not carry, like the walk to a pharmacy, the noise on a Friday night and how far the nearest private hospital actually is.
...
The recurring retirement mistakes divide into three kinds. Financial: underestimating closing costs and assuming a US-level pension stretches uniformly. Legal: using the seller's lawyer, or buying communal land marketed as private. Lifestyle: choosing a climate on a two-week winter visit and discovering the summer, or moving somewhere with no plan for the day driving becomes difficult. The first two cost money; the third costs the retirement.
...
Plan twelve to eighteen months from first research to keys, and spend the first three of them visiting rather than searching. The sequence that works is: extended visits in two or three shortlisted markets across different seasons, then legal and tax advice on both sides of the border, then property search, then a 45–90 day closing. Compressing the visiting stage is the most common way retirees end up somewhere they later leave.
...
A: Yes, US citizens can legally own property anywhere in Mexico. Properties within 50km of the coast or 100km of borders require a fideicomiso ([bank trust](/guides/fideicomiso-mexico-explained/)), while inland properties can be owned directly.
