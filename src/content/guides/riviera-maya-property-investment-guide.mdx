---
title: "Riviera Maya Real Estate: 3-5% Net Yield 2026"
...
readingTime: 17
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1788403687/more-group/mexico/guides/riviera-maya-property-investment-guide/hero.jpg"
heroAlt: "Aerial view of dense high-rise blocks along the beach at Punta Cancun, Quintana Roo"
relatedSlugs:
...
![Tren Maya](https://res.cloudinary.com/dphvjbqb4/image/upload/w_960,q_85,f_webp/v1781460868/more-group/mexico/guides/riviera-maya-property-investment-guide/inline_1.jpg)

![Golf 2019 3 11zon](https://res.cloudinary.com/dphvjbqb4/image/upload/w_960,q_85,f_webp/v1781460869/more-group/mexico/guides/riviera-maya-property-investment-guide/inline_2.jpg)
...
Spread, not the peak, is what makes Playa the corridor's default. Its three prime colonias cluster between 4.3% and 4.5% net, a 20 basis point range, while Tulum spans 2.6% to 3.4% and Cancún 3.5% to 4.2% on comparable tickets. A buyer who picks reasonably well in Playa lands close to the market return; a buyer who picks badly in Tulum earns less than half what a selective buyer earns on the same money. Narrow distribution is worth more to most investors than a higher ceiling.
...
Tulum in 2026 is two markets that share a name and a postcode. Region 15's commodity towers net 2.6% on 74-plus days to sell, with identical-unit competition that no operator repairs; established Aldea Zama product nets 3.4% and moves in 70 to 100 days. Median 1BR pricing near $285,000 spans both. The opportunity is real for a buyer who can tell them apart and uses the current negotiating leverage on the right building; the risk is that the corridor average describes neither, and a buyer underwriting 3% on a Region 15 unit is 40 basis points optimistic before the first booking.
...
State-level appreciation near 14.7% in 2025 made headlines, and it describes almost nothing a buyer will actually transact in. The number averages premium new launches that still clear at developer pricing with resale stock in oversupplied pockets that does not. At micro level:
...
The Riviera Maya has moved from informal nightly letting to registered, taxed letting in under three years, and the direction is one-way. Municipalities tightened STR registration and tax collection. Buildings increasingly encode rental rules in HOA bylaws. Before buying for Airbnb:
...
## Due diligence specific to the Riviera Maya

Four checks matter here that would not appear on a due-diligence list for an inland or non-coastal purchase. Each one has ended deals in this corridor: Cenote and environmental clearance, ejido boundary distance on the survey, written short-term rental permission in the regime, and the count of identical units already listed in the building.
...
Four patterns recur in Riviera Maya marketing, and each one is a reason to slow down rather than a detail to negotiate later: Guaranteed yields, developer projections presented as operating history, Aldea Zama occupancy bands applied to Region 15 inventory, and any deposit requested outside escrow.
...
Puerto Morelos sits between Cancún and Playa and trades at a discount to both: roughly $180K to $240K for an indicative 1BR, against thinner resale liquidity when you come to exit. The case for it, and against it:
...
Enforcement arrived market by market rather than all at once, and where it has landed it has not reversed. The sequence across the corridor: Solidaridad first, then Tulum, then the smaller municipalities, and each step tied platform listings to a named operator and a tax account rather than adding a new rule.
...
Tulum is built over a limestone aquifer, so environmental permitting is a live construction risk rather than a formality. Projects halted mid-build create ghost inventory and buyer losses, and the water table and cenote setback rules are what halts them. Projects halted mid-construction create ghost inventory and buyer losses.
...
## Exit planning in the Riviera Maya

The work that makes an exit clean is done years before it, and a seller who starts assembling it at listing time loses both months and price. Three things in sequence: A documented CFDI cost basis from the first payment, an RFC registered before the first booking, and two years of clean operating statements. All three are cheap during the hold and impossible to create at listing.
...
Every coastal Riviera Maya purchase by a foreigner runs through the same three legal steps, in this order, and none of them is optional: Registry and title verification, the SRE permit and trust constitution, then the notario closing with CFDIs issued and retained. Skipping the third step is what produces an ISR problem five years later.
...
This is the most foreigner-oriented property market in Mexico, which cuts both ways: the infrastructure is genuinely good and the volume attracts brokers who add none of it. Quintana Roo new condo sales often report majority foreign buyers, AMPI brokers fluent in English, USD contracts common, notarios experienced with fideicomiso volume.
...
Syndicated entry-tier deals circulate informally in this corridor and the due diligence behind them rarely matches what the same buyer would demand on a purchase of their own. WhatsApp groups pitch "RM syndicates" at entry tier, DD rarely matches individual purchase standard.
...
The corridor breaks into distinct micro-markets, and the entry price, rental depth and permit position differ enough between them that a decision made at corridor level is not really a decision. Start here: Playa nets 4.3–5.2%, Tulum ranges from 2.6% in Region 15 to 3.4% in Aldea Zama, Puerto Morelos and Akumal sit near 3.5–4% with steadier calendars. Choose the micro-market before choosing the building.
