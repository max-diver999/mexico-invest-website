...
Tulum is built over a limestone aquifer, so environmental permitting is a live construction risk rather than a formality. The water table and cenote setback rules are what halt projects here, and a project stopped mid-build leaves ghost inventory behind and inflicts losses on its buyers.
