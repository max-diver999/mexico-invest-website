...
Commercial guide: [Playa del Carmen](/areas/playa-del-carmen/).
...
<CtaBox
  title="The corridor is four markets, not one"
  description="Tell us the budget and the intended use and we will come back with which stretch of coast fits, and what the running costs look like on each of them."
