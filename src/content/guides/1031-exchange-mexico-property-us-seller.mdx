---
title: "1031 Exchange and Mexican Property: US Sellers"
...
Ownership wrappers are where sellers most often hope for an exception, and none of them works. A fideicomiso makes a Mexican bank the titleholder while you hold beneficial rights, but for US tax purposes the economic asset remains a Mexico real property interest, so selling those rights is not converted into a US real property transaction. A Mexican corporation holding the condo adds entity-level tax, Form 5471 reporting, monthly accounting at $200 to $600, and dividend withholding of up to 10% on distributions to foreign shareholders, and still does not create a domestic like-kind asset. The jurisdiction of the underlying land decides the question, and no structure layered above it changes that.
...
Carrying the illustration through to cash shows the size of the planning error. Against a $470,000 sale price, Mexican ISR withheld at $31,000 leaves roughly $439,000 wired abroad before US tax. On the $144,000 simplified US gain, federal long-term capital gains tax at 15% is about $21,600, the $22,000 of depreciation recapture is taxed at up to 25% rather than 15%, and net investment income tax at 3.8% may add a further $5,500. Foreign tax credit for the $31,000 of ISR offsets much of that but is capped by Form 1116 limits and does not reach state tax. A seller planning on $400,000 net for a US purchase should model the whole chain before agreeing an asking price.
...
## Alternative 1: sell Mexico, pay ISR and US tax, th
