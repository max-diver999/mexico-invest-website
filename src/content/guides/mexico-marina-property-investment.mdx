...
|---|---|---|
| Will you use a slip 12+ weeks/year? | Yes | |
| Is net yield above 5% required? | | Yes |
| Hold period under 5 years? | | Yes |
| Need broadest resale buyer pool? | | Yes |
| Fishing / charter STR is core strategy? | Yes | |
| Comfortable with dual HOA + marina fees? | Yes | |
| Verified marina financials provided? | Yes | Stop if no |
