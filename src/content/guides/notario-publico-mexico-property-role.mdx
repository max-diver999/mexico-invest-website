...
Notarios hold a federal appointment after examination and merit selection. Their acts carry public faith, courts presume authenticity of properly executed notarial instruments. That public faith is why the notario cannot advocate for you: their function is to attest that the act happened lawfully, which requires neutrality between the parties. A buyer who expects representation from the notario has misread the role, and it is the most consequential misreading in a Mexican purchase.
...
Notario charges are only part of the closing stack and buyers routinely quote the wrong total. On a $300,000 purchase the notario-side items — honorarios at 1% to 1.5%, registry inscription at 0.3% to 0.5%, appraisal at $300 to $800 and certificates at $200 to $600 — come to roughly $4,500 to $6,000. ISAI at 2% to 4% adds another $6,000 to $12,000, the fideicomiso adds $2,500 to $4,000, and an independent attorney adds $1,500 to $5,000. Total cash at the closing table is therefore $14,500 to $27,000, none of it financeable.
...
Under-declaring the purchase price is the classic false economy in Mexican property and the numbers make it obvious. Recording $280,000 on a $350,000 purchase saves 2% to 4% of the hidden $70,000 at closing, or roughly $1,400 to $2,800 of ISAI. The same $70,000 then sits outside your cost basis at exit, so a later sale at $420,000 presents a $140,000 gain instead of $70,000 — worth about $24,500 of extra ISR at the 35% net method. The saving is real, small, and multiplied roughly tenfold against you at sale.
...
The two roles are complementary and neither substitutes for the other. The notario validates the act, calculates the taxes and files with the registry; your attorney investigates the property, negotiates the contract and tells you when to walk. Best outcomes come when the attorney is engaged first and selects or approves the notario, rather than inheriting whichever one the seller nominated.
...
## Sample notario balance sheet (illustrative)
...
First sale from developer may register regime de condominio master deed before unit escritura. Notario confirms: On a first sale the master deed constituting the régimen has to be registered before your unit deed can exist, so a developer selling units before the regime is registered is selling something that cannot yet be conveyed.
...
Five questions worth asking before you accept a notario, and they are all about foreign-purchase experience rather than about fees. How many fideicomiso closings have they handled this year, which trustee banks do they work with regularly, what is their current timeline from instruction to signing, will they issue a preliminary cost estimate before you make a binding offer, and who at the office communicates in English.
...
Two or more foreign buyers can hold one trust with defined shares, which is how couples and partners normally structure a Mexican purchase. The parts that need deciding at the deed rather than afterwards are the share split, the survivorship provision, and the substitute beneficiary designation — changing any of them later means amending the trust with the bank.
...
## Who the notario works for, and who they do not

**The buyer.** The notario validates the deed and calculates the taxes; they do not represent you, do not negotiate for you and do not perform the commercial diligence that protects you. That gap is why an independent attorney is a separate line in the budget rather than a duplication.

**The seller.** The notario calculates and withholds your ISR at closing, which makes their arithmetic the tax outcome unless a projection was obtained beforehand.

**The foreign buyer specifically.** The notario is the point at which the trust, the SRE permit and the registry filing all converge, and choosing one who handles foreign purchases routinely — rather than the one the seller nominates — is worth the small extra fee.
