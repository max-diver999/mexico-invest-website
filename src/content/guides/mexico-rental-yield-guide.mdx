...
A strong gross yield on a unit with a title or governance problem is a discount for risk, not a bargain. Three findings should end the conversation whatever the pro forma says:
...
The management fee headline is 25% to 35%, but the clauses underneath it decide what you actually keep. Read these three before signing with any manager:
