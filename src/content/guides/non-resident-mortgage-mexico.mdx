...
If the ownership mechanics are new to you, start with [Buy Property Mexico Foreigner](/guides/can-foreigners-buy-property-mexico/) and [Fideicomiso Mexico Explained](/guides/fideicomiso-mexico-explained/) before pricing debt; the market these loan programs operate in is described in the [Riviera Maya Property Investment Guide](/guides/riviera-maya-property-investment-guide/).
