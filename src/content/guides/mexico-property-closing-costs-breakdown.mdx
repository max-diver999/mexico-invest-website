...
<TldrBlock text="Plan on 5–10% of the purchase price in extra cash to close in Mexico: ISAI transfer tax at 2–4% by state, the mandatory notario near 1–1.5%, registry inscription, trust setup around $2,500–4,000 on coastal purchases, and your own attorney at $1,500–5,000. On a $300K condo that means finding $15K–30K beyond the price." />
...
This page runs the scenario math; the line-by-line fee reference behind it is [Cost of Buying Property Mexico](/guides/cost-of-buying-property-mexico/), and the sequence of when each payment falls due is in [How to Buy Step by Step](/guides/how-to-buy-mexico-property-step-by-step/).
...
What the trust actually is, and why its renewal line recurs for fifty years, is explained in [Fideicomiso Explained](/guides/fideicomiso-mexico-explained/).
...
Whether financing any part of this stack is realistic for a non-resident is covered in [Mortgage for Non-Residents](/guides/non-resident-mortgage-mexico/).

---

<CtaBox
  title="Want your closing stack priced before you offer?"
  description="Send the target market, price band and whether the deal is coastal. We reply with the closing costs we would budget line by line for that specific purchase — ISAI at the right state rate, realistic trust and legal fees, and the all-in figure to underwrite from."
  buttonText="Price my closing costs →"
  href="/get-shortlist/"
/>
...
## What to verify next
Four checks sit adjacent to the closing stack itself: [USD/MXN exposure](/guides/currency-risk-mexico-property-usd/) on the funds you wire, the building's [HOA fee history](/guides/hoa-fees-mexico-condo/), [lodging tax and STR registration](/guides/quintana-roo-lodging-tax-registration-guide/) if the unit will rent, and the [developer's track record](/guides/developer-due-diligence-mexico/) on any pre-construction file. Start with the last one: escrow practice and milestone discipline change what you actually pay far more than the published fee schedule does. The line-by-line fee reference itself lives in [Cost of Buying Property Mexico](/guides/cost-of-buying-property-mexico/).
