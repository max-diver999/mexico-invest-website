...
## What to verify next
Verify before you commit: [USD/MXN exposure](/guides/currency-risk-mexico-property-usd/) · [HOA fees](/guides/hoa-fees-mexico-condo/) · [closing costs](/guides/cost-of-buying-property-mexico/) · [lodging tax and STR registration](/guides/quintana-roo-lodging-tax-registration-guide/) · [developer track record](/guides/developer-due-diligence-mexico/). The closing-cost line on this list is the article's own subject, so start instead with developer track record on any pre-construction file: escrow practice and milestone discipline change what you actually pay far more than the published fee schedule does.
