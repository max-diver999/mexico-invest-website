...
<CtaBox
  title="Whether IVA applies depends on the let"
  description="Tell us the property type and the letting model, and we will come back with whether IVA is chargeable, at what rate, and what the platform is already withholding."
