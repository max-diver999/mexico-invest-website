...
<CtaBox
  title="Two products often sold in the same room"
  description="Send us the paperwork and we will tell you which one is on the table, what you would own in each case, and what happens when you want to stop paying."
