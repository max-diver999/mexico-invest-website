---
title: "Co-Ownership of Mexican Property: Rules and Risks"
...
Quick answer: Foreigners can co-own [Mexico property](/guides/mexico-property-investment-guide/) through fideicomiso joint beneficiaries (residential coastal property) or [Mexican corporation](/guides/fideicomiso-vs-mexican-corporation/) structures (commercial property). Co-ownership agreements should specify ownership percentages, decision-making authority, exit strategies, and dispute resolution mechanisms to prevent conflicts.
...
Co-ownership sits on top of whichever structure holds the property, so settle that first: a coastal purchase runs through the [fideicomiso](/guides/fideicomiso-mexico-explained/), and the [corporate alternative](/guides/fideicomiso-vs-mexican-corporation/) only makes sense at portfolio scale. Whatever the structure, the [notario](/guides/notario-publico-mexico-property-role/) has to see the agreement before closing.
...
![The Reef Resorts And Spa 1920X10801](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460739/more-group/mexico/guides/co-ownership-mexico-property/inline_1.jpg)

![Kempinski Hotel Cancun](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460740/more-group/mexico/guides/co-ownership-mexico-property/inline_2.jpg)
...
Three provisions do the work and their absence is what produces litigation. A buy-sell mechanism with a defined valuation method lets one owner exit without the others' consent; a usage calendar with enforcement prevents the peak-week disputes that account for most co-owner conflict; and a deadlock-breaking provision keeps a disagreement out of a Mexican court, where a forced sale typically clears 20% to 30% below market and takes years. On a $600,000 property held four ways, that discount is $30,000 to $45,000 per owner.
...
Many partnerships delegate day-to-day decisions to professional [property management](/guides/property-management-riviera-maya-cost/) companies while retaining authority over major financial and strategic decisions. Management contracts specify delegation scope and reporting requirements.
...
## Tax treatment of a co-owned property
...
Valuation method matters more than the buy-out trigger, because the trigger is easy to agree and the price is not. Name the mechanism in advance, an average of two independent Mexican appraisals, or a formula against comparable sales, and apply an explicit minority discount if one is intended, rather than leaving it to negotiation between people who have stopped speaking. Give the remaining owners 60 to 90 days to fund, and specify what happens if they cannot: a third-party sale, or a forced listing of the whole property.
...
<CtaBox
  ...
  description="Bank fee schedules differ by institution and by declared value, and the spread compounds over a hold measured in decades. Tell us the property and the budget, and we will come back with what the structure actually costs on it."
...
## Running a co-owned property day to day
