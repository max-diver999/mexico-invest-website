...
<CtaBox
  title="Shared ownership needs an exit clause first"
  description="Tell us who is buying with whom and we will come back with the structures available, and what each one does when one party wants out and the other does not."
