...
readingTime: 13
heroImage: "https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460741/more-group/mexico/guides/cost-of-buying-property-mexico/inline_1.jpg"
relatedSlugs:
...
US buyers accustomed to 2-3% closing stacks in some states get surprised in Mexico. The notario system is non-optional, the fideicomiso is additive in coastal zones, and ISAI scales with value. This guide itemises every line so your all-in basis, critical for future ISR capital gains, is accurate from day one. Before the costs, the price: [homes for sale in Mexico](/guides/homes-for-sale-mexico/) sets out indicative bands by city.
...
![Meliponario, Yucatán](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460742/more-group/mexico/guides/cost-of-buying-property-mexico/inline_2.jpg)
...
Placing the trust inside the whole closing stack shows how small a share it is. On a $320,000 Playa purchase, ISAI at 2% to 4% is $6,400 to $12,800, notario and registry roughly $4,200 to $6,400, an independent attorney $1,500 to $5,000, and the fideicomiso all-in at $2,500 to $4,000, which already includes the $1,200 to $1,700 SRE permit. Total closing lands at $14,900 to $28,700, of which the trust is 14% to 17%. Buyers who fixate on the fideicomiso as the cost of being foreign are looking at the smallest of the four major lines.
...
Cost against exposure is the entire argument for independent counsel. At $1,500 to $5,000, an attorney's review of the registry certificate, the ejido screening, the HOA bylaws and the purchase agreement costs roughly 0.5% to 1.5% of a $320,000 purchase. The defects it catches, an unconverted ejido parcel, a lien registered after the seller's last certificate, a condominium regime that prohibits nightly letting, each cost either the entire purchase price or the entire rental thesis. The notario is neutral by law and will not do this work for you.
...
Off-plan changes the shape of the cost, not the total: you pay in instalments across the build and the transfer tax only lands at the deed on completion, often two years after your first payment. Treat the schedule as project finance rather than a closing statement, the question is what each tranche buys and who holds it, not what the sum is.
...
Five steps, and the first removes most of the uncertainty on its own: ask the notario for a preliminary estimate before you make a binding offer. Everything after it protects the number, confirming how ISAI will be calculated, keeping every CFDI, putting the all-in figure into the yield model, and holding a 2% contingency for peso movement on peso-denominated fees.
...
## ISAI deep dive: how states calculate acquisition
...
The notario line on a Mexican closing statement is five separate charges bundled into one number: the notario's own fee for preparing and supervising the deed, the appraisal, coordination of the seller's ISR withholding, the public registry filing, and the lien-free and tax-clearance certificates. Ask for them itemised, the appraisal and the certificates vary far more than the fee itself.
...
Trust setup is where first-time buyers and repeat buyers diverge most sharply, and the difference is worth planning around. A new fideicomiso on a first purchase runs $2,500 to $4,000 all-in, including the SRE permit's MXN 21,650 federal duty, and takes two to four weeks. Assuming an existing trust on a resale is a modification rather than an establishment: roughly $800 to $1,500 and one to two weeks. That spread is real money on a sub-$250K ticket, and it is one of the few closing-cost lines a buyer can actually influence, by preferring resale stock where the seller's trust can be assumed.
...
## Regional cost variations: comprehensive breakdown
...
The three main foreign-buyer states charge broadly the same: ISAI around 2-3%, notario and registry around 1.5-2%, on a $350,000 condo. Jalisco has the widest spread because ISAI is set at municipal level and Banderas Bay crosses two states. The real divergence is not the closing stack but what the property costs to carry afterwards.
...
Add fideicomiso and legal flat fees equally across coastal restricted zones. Genuinely inland purchases beyond the 50 km band skip fideicomiso but still pay ISAI and notario; Mérida city is not one of them, sitting about 35 km from the Gulf.

---

<CtaBox
  title="What the purchase adds on top of the price"
  description="Give us the purchase price and the state and we will come back with the ISAI band, the notario scale, the trust cost if it applies, and a total you can budget against."
...
The buyer pays almost everything: ISAI, notario, registry, trust setup and their own legal costs. The seller pays their own ISR and the broker commission. That split is convention rather than law, so it is negotiable at the margin on a motivated resale, but ISAI and the core notario fee effectively never move.
...
## Worked comparison: $400K in Los Cabos vs $400K in Playa

Two purchases at the same price close for almost the same money, roughly $23,000 either side, and then diverge sharply on carry. The closing stack is a national formula; the HOA is a building decision, and over a five-year hold it is the larger number of the two.
...
## Annual carry as a percentage of purchase price

Carrying a $300,000 condo costs roughly 1.6-1.8% of its price every year, and the HOA is about three quarters of that. Predial and the fideicomiso together come to under 0.4%. Closing costs hurt once; this recurs, and over a seven-year hold it exceeds the closing stack several times over.
...
Two seller-side costs reach you indirectly. The broker commission is embedded in the asking price rather than added to your stack, which is part of why list prices in Mexico carry negotiation room. And the seller's ISR is withheld at closing, normally invisible to you, unless tax arrears have put a lien on the property, which diligence occasionally turns up.
