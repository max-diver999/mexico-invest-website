...
readingTime: 15
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1788435438/more-group/mexico/guides/rental-contract-mexico-foreign-landlord/hero.jpg"
heroAlt: "Colonnaded limestone courthouse of the Yucatán state high court, Mérida"
relatedSlugs:
...
A contract is only half the picture. The tax side runs through [SAT registration and CFDI invoicing](/guides/sat-rental-registration-mexico/), the nightly-let side through [municipal STR rules](/guides/short-term-rental-rules-riviera-maya/), and the day-to-day through a [property manager](/guides/property-management-riviera-maya-cost/) whose contract terms matter as much as the tenant's.
...
![Mice Royalton](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460864/more-group/mexico/guides/rental-contract-mexico-foreign-landlord/inline_1.jpg)

![Mice LINKERA MONTAJE ACDELCO](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460867/more-group/mexico/guides/rental-contract-mexico-foreign-landlord/inline_2.jpg)

---

## RFC requirements for a foreign landlord
...
Choosing between the two ISR regimes is the highest-value tax decision a foreign landlord makes, and the arithmetic favours net for most short-term rentals. On $21,000 of gross, the 25% gross regime costs $5,250 with no deductions available. The net regime applies progressive rates up to 35% to income after management, HOA, predial, depreciation and the trust fee, commonly leaving a base near $9,000 and a bill well under the gross figure. The election requires an RFC, costs $300 to $800 to set up through a contador, and is not retroactive within the calendar year.
...
Mexican tenancy law leans toward the occupant, and a long-let contract that has not been drafted with that in mind is where foreign landlords lose time and money. Where the plan is nightly rather than annual letting, the governing rules are different again; see [short-term rental rules](/guides/short-term-rental-rules-riviera-maya/) before you sign anything with a tenant.

Mexican tenancy law favours the tenant in ways foreign landlords consistently underestimate. Removing a non-paying tenant runs through the courts and commonly takes 6 to 12 months, during which the unit produces nothing and cannot be relet, while the HOA, predial and trust fee continue. That risk is the strongest argument for careful screening and for a fiador or deposit structure, and it is also why short-term letting, where the guest leaves on schedule, carries a different risk profile from an annual lease despite the heavier compliance load.
...
## Currency and banking mechanics
