...
Corridor context: [Playa del Carmen area guide](/areas/playa-del-carmen/) and.
...
Colonia guides: [Tulum](/areas/tulum/) and.
...
<CtaBox
  title="Annual occupancy averages hide the trough"
  description="Tell us the building and we will come back with month-by-month figures for comparable units, which is where a projection either holds or falls apart."
