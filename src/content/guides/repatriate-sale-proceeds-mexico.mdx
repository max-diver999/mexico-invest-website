...
Quick answer: Mexico does not restrict repatriation of property sale proceeds. The sequence is: notario withholds ISR on closing day, [fideicomiso](/guides/fideicomiso-mexico-explained/) closes and releases net proceeds (2–4 weeks), bank wires funds internationally (1–3 days). US [capital gains](/guides/mexico-capital-gains-tax-foreign-seller/) tax applies separately. Documentation of your cost basis is the single biggest lever on how much you pay.
...
Getting paid is the last step of a sequence that starts much earlier: the [ISR withholding the notario applies](/guides/mexico-capital-gains-tax-foreign-seller/) depends on the [CFDI trail you kept from day one](/guides/cfdi-cost-basis-mexico/), and the [sale process itself](/guides/how-to-sell-mexico-property-from-abroad/) sets the timeline.
