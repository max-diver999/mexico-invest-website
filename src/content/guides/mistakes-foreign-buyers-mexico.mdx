...
Quantifying the exit cost is what changes behaviour at the closing table. A buyer who pays $350,000 with $70,000 undocumented, so the escritura records $280,000, and who later sells at $420,000, presents a $140,000 gain rather than the $70,000 the full basis would have supported. At the 35% net method that is roughly $24,500 of additional ISR withheld by the notario. The saving that produced it was a few thousand dollars of ISAI at purchase. There is no retroactive fix: CFDI invoices must be issued at the time of payment, by the party being paid.
