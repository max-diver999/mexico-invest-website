...
Currency of these documents matters as much as their existence, and 30 days is the working standard. A certificado de libertad de gravamen pulled six months ago proves nothing about liens registered since, and Mexican registries record encumbrances continuously. Order the set yourself through your own attorney rather than accepting copies from the seller or the listing agent, budget $1,500 to $5,000 for that independent review, and treat any refusal to let you pull them fresh as the finding. The registry is public; a seller with clean title has no reason to object.
...
![Valladolid aventura](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460748/more-group/mexico/guides/due-diligence-mexico-real-estate/inline_1.jpg)

![Valladolid, Yucatán](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460751/more-group/mexico/guides/due-diligence-mexico-real-estate/inline_2.jpg)
...
Screening cost against loss exposure is the entire argument here. An attorney's ejido check through Registro Agrario Nacional records runs $300 to $800 and takes days; the downside it prevents is the full purchase price, because unconverted communal land cannot lawfully transfer to a foreigner and no later structure repairs it. A parcel priced 40% or more below comparable private land is the usual signal, and that discount is not a bargain — it is the market pricing in a title nobody can insure, register or lend against. Run the check before the deposit, because a refundable reservation under $5,000 is the only stage at which this defect costs you nothing.
...
Every peso you can document at purchase is a peso you do not pay ISR on at sale, so the CFDI trail is built at closing rather than reconstructed years later. Ask the notario to confirm that a CFDI invoice is issued, in the buyer's name, for each of the following:
...
The contract is where a purchase either protects you or does not, and the protective clauses are the ones sellers leave out rather than refuse. A purchase agreement should specify, in writing: The protective clauses are the ones a seller omits rather than refuses, so read for absence: a diligence window with a refundable deposit behind it, defined escrow release conditions, delay penalties on pre-construction, and what happens if a finding in phase four turns out to be real.
...
Most failed Mexican purchases were visible during due diligence and pursued anyway. Six findings are not negotiating positions, they end the deal. Stop immediately if any of these appears: Each of the six below has ended purchases that looked fine on price, and none of them improves with negotiation. The distinction worth internalising: a finding that costs money is a price conversation, a finding that touches title is not.
...
## Document request list: send this

Professional buyers open with a written document request before they see the view, because the seller's response to the list is itself information: a complete pack inside a week and a stalled one both tell you something. Send this:
...
Ejido land cannot be sold to a foreigner and no structure fixes that, so listings for it are worded to avoid saying what is on offer. Four phrases do most of that work, and each has a plain translation:
...
A weak HOA surfaces as a special assessment two years after closing, and the warning sits in accounts you can read before you buy. Four numbers separate a fund that is solvent from one that is about to bill its owners:
...
## Regional due diligence variations across Mexico ma
...
Salt air, humidity and heavy seasonal rain break buildings in ways a US or Canadian inspection checklist does not look for. Brief the inspector on the failure modes specific to coastal Mexico: Waterproofing first, then electrical capacity for air-conditioning load, then anything metal within reach of salt air. A US inspection checklist looks for none of these three, and they are what actually fail in Riviera Maya and Baja buildings within three to five years.
...
A power of attorney lets someone sign for you, which means due diligence has to cover the attorney as well as the property. If you are closing through a POA rather than in person: Specifically: that the poder is limited to this transaction, names a maximum price, prohibits wiring anywhere other than a named account, and carries an expiry date. A general power of attorney handed to someone you met through the seller is the largest single risk in a remote purchase.
...
## Common due diligence failures, and how to prevent them
...
## The DD outcome letter your attorney should deliver

Due diligence ends with a written opinion or it did not really end. Expect a memo from your attorney rather than a phone call, covering: A written memo is what makes the diligence auditable later — by you, by a lender, and by the buyer you eventually sell to. A phone call that says "looks fine" leaves you with nothing to point at when something surfaces two years on.
...
HOA minutes, escrituras and lien certificates all arrive in Spanish, and a verbal summary is not the same as a translation. Ask your attorney to summarise the material votes in English and keep the originals on file:
...
Due diligence produces a pile of documents and no verdict unless you force one. Score each line from 1 to 5 and proceed only where the average clears 4 and the ejido check is a clean 5, because that one does not average out:
