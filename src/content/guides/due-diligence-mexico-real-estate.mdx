...
readingTime: 15
heroImage: "https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460748/more-group/mexico/guides/due-diligence-mexico-real-estate/inline_1.jpg"
relatedSlugs:
...
Process: [Buy Property as Foreigner](/guides/can-foreigners-buy-property-mexico/).
...
<CtaBox
  title="Have the file checked before you travel"
  description="Send us the listing and we will come back with what the public registry shows, whether the seller is the registered owner, and whether any lien or unpaid predial is attached."
