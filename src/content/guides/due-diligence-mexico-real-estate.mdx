...
The contract is where a purchase either protects you or does not, and the protective clauses are the ones sellers leave out rather than refuse. A purchase agreement should specify, in writing:
...
Most failed Mexican purchases were visible during due diligence and pursued anyway. Six findings are not negotiating positions, they end the deal. Stop immediately if any of these appears:
...
Salt air, humidity and heavy seasonal rain break buildings in ways a US or Canadian inspection checklist does not look for. Brief the inspector on the failure modes specific to coastal Mexico:
...
A power of attorney lets someone sign for you, which means due diligence has to cover the attorney as well as the property. If you are closing through a POA rather than in person:
...
## Common due diligence failures and prevention strat
...
Due diligence ends with a written opinion or it did not really end. Expect a memo from your attorney rather than a phone call, covering:
