...
Fee percentage alone is a poor comparison and the exclusions decide the real cost. A 22% quote that bills cleaning, guest supplies, maintenance dispatch and permit administration separately can land above a 30% all-inclusive quote once the year is totalled. On a $32,000 gross, the difference between 22% and 30% is $2,560, while cleaning at $50 to $100 per turnover across 80 stays is $4,000 to $8,000 on its own. Ask every manager for a specimen annual statement from a comparable unit, not a fee percentage.
...
Management and HOA together take the majority of gross in most Riviera Maya models, which is why they belong in the same sentence. On a Playa Centro 1BR grossing $21,000, management at 27% is $5,670 and a $350 HOA is $4,200 — $9,870 combined, or 47% of everything the property earns, before predial, the trust fee, utilities and vacancy. Those two lines, not the nightly rate, are where a 6.6% gross becomes a 4.4% net, and both are knowable before you make an offer from a manager quote and 24 months of HOA statements.
...
The manager arranges repairs and you pay for them — a distinction that surprises owners reading a 25% "full service" fee. Budget $1,500–3,000 a year for a coastal one-bedroom: air conditioning servicing two or three times, a water heater every few years, and the humidity-driven attrition that Riviera Maya inflicts on everything electrical.
...
Five contract terms that should end the conversation. The last one is the least obvious and the most dangerous: a manager named as sole holder of your municipal rental permit, with no transfer clause, owns your ability to operate — and you will discover it the day you try to change managers.
...
Two fees come off the same revenue and owners routinely count only one. The platform takes 3–15% depending on which fee model the listing uses, and the manager takes 20–30% of gross on top. Whether the manager's percentage is calculated before or after the platform fee is worth asking explicitly — it is roughly half a point of net yield.
...
Management pricing is negotiable from the second unit and genuinely custom from the fourth: two or three units in the same building typically buy a 2–3% discount, because the manager's marginal cost per unit falls sharply when the cleaning crew is already on site.
...
A manager who charges the same rate in February and September is not doing revenue management, they are running a calendar. What separates operators is the shoulder and trough strategy — length-of-stay discounts, monthly rates for remote workers, and an enforced rate floor that keeps August from being sold below operating cost.
...
The gap is real money over a hold. Playa's deeper manager pool holds fees at 20% to 25% where Tulum's newer zones charge 25% to 35%, and across ten years on a $21,000 gross that difference is roughly $16,000 — more than the fideicomiso costs over the entire period. Factor it into any city comparison rather than treating management as a constant.
...
Utilities are the owner's, not the manager's, and they run roughly $95–260 a month on a Riviera Maya short-term rental. Electricity is the volatile line: CFE tariffs step up sharply above certain consumption bands, and guests running air conditioning at 20°C with the balcony door open is how a $60 bill becomes $150.
...
Around $450–900 of one-off hardware removes most of the operational friction in a remote-owned rental: a smart lock ends key handovers, an exterior camera settles access disputes, and a noise monitor prevents the party that ends your HOA rental permission. Interior cameras are prohibited by every platform and by good sense.
...
Your manager's monthly statement is the source document for two tax filings, so it has to itemise rather than net out: gross bookings, platform fees, management fee, cleaning and any expenses advanced. A statement that reports only what was deposited to you makes the deductions unprovable in both countries.
...
At $30,000 of annual gross and a 25% fee, management costs $37,500 over five years — more than the furnishing budget and closing costs combined. That number is why a two-point difference in fee is worth negotiating hard for, and why the cheapest manager is rarely the answer: two points of fee is less than two points of occupancy.
...
Two quotes before the contingency lifts is the practical rule, and the second quote is what reveals what the first one excluded. Fee spread and service quality vary more between operators in the same colonia than most buyers expect, so ask each for a specimen annual statement from a comparable unit rather than a percentage.
...
## Which owner needs which service level

**The remote owner with one unit.** Full service at 25–30%, and the fee is not optional: turnovers, guest messaging and maintenance dispatch all require somebody local, and the alternative is a property that underperforms by more than the fee saved.

**The owner present part of the year.** A partial arrangement at 15–22% can work for the months you are there, provided the handover between self-management and managed operation does not cost the listing its ranking.

**The multi-unit owner.** Negotiating leverage starts at the second unit in the same building and becomes real at four, where custom terms, capped maintenance markups and consolidated reporting are all obtainable.

---

## What to verify next
Verify before you commit: [HOA fees](/guides/hoa-fees-mexico-condo/) · [closing costs](/guides/cost-of-buying-property-mexico/) · [lodging tax and STR registration](/guides/quintana-roo-lodging-tax-registration-guide/). HOA is the line to weight heaviest here, because on a $21,000 gross a $350 monthly fee and a 27% management fee together consume 47% of everything the property earns.
