...
For the ownership rules that apply to all foreigners, start with [Can Foreigners Buy Property in Mexico?](/guides/can-foreigners-buy-property-mexico/) and.
...
<CtaBox
  title="Residency and buying are separate processes"
  description="Tell us your income position and where you would apply, and we will come back with the threshold that consulate applies and how it interacts with a purchase."
