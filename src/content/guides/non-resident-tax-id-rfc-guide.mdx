...
readingTime: 14
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1788439493/more-group/mexico/guides/non-resident-tax-id-rfc-guide/hero.jpg"
heroAlt: "The SAT tower (Torre Caballito) rising over central Mexico City under a clear sky, the tax authority's logo near the top"
heroShared: false
relatedSlugs:
...
<CtaBox
  title="Do you actually need an RFC for this purchase?"
  description="Send us what you are buying and whether you intend to let it, and we will come back with whether registration is required, optional or a mistake in your case."
