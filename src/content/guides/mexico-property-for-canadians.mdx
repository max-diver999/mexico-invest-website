...
![Jaguar sculpture, Riviera Maya](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460813/more-group/mexico/guides/mexico-property-for-canadians/inline_1.jpg)

![La Valise](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460813/more-group/mexico/guides/mexico-property-for-canadians/inline_2.jpg)

---

## Legal structure: identical to other foreigners

Canadians use fideicomiso bank trusts in restricted zones, no special Canadian treaty or structure. Nationality changes nothing in the constitutional test: the fideicomiso costs $2,500 to $4,000 to establish and $500 to $800 a year for a Canadian exactly as for an American, and the 50 km coastal band applies identically. What is Canada-specific sits on the reporting side — CRA Form T1135 once specified foreign property passes CAD 100,000 in cost, and the foreign tax credit against Mexican withholding — not in how title is held.
...
Three currencies is one more than most Canadian buyers plan for, and the middle one does the damage. Purchase price, HOA and management are typically USD-denominated in resort markets, so a Canadian carries full CAD/USD exposure on the asset and the largest operating costs, while predial and utilities sit in pesos. A 10% CAD weakening against the dollar raises a $310,000 purchase to the equivalent of $341,000 with nothing changed about the property. Budget a 10% to 15% cushion and consider a forward contract on the purchase commitment itself.
...
Form T1135 is the filing Canadians most often miss and the threshold is low. Specified foreign property with a total cost above CAD 100,000 triggers it, and a Mexican condo alone clears that on almost any purchase in Playa, Puerto Vallarta or Los Cabos. Penalties start at CAD 25 a day to a CAD 2,500 maximum per year and rise sharply for gross negligence. Rental income is reportable to CRA regardless of Mexican tax withheld, with the foreign tax credit preventing double taxation only where the Mexican withholding is properly documented on a retención certificate. Expect CAD 1,500 to 4,000 a year in cross-border accounting fees on a rented property.
...
Canadian flight capacity is the demand signal worth tracking for a Canadian owner, because it drives both your own access and your guest mix. Direct winter service from Toronto, Montreal, Calgary and Vancouver into Cancún, Puerto Vallarta and Los Cabos concentrates Canadian visitors between December and April, which is exactly when Riviera Maya occupancy peaks near 80%. That overlap is convenient and it is also a constraint: the weeks you most want for personal use are the weeks your listing earns its highest rate, at $3,000 to $5,000 of gross per peak week on a Playa 1BR.
...
Weeks 1-2: Offer acceptance, deposit (typically 1-5% held in escrow or with notario), [due diligence](/guides/due-diligence-mexico-real-estate/) period begins.
...
Methodology: [Net yield](/guides/mexico-rental-yield-guide/) calculated after management (25-30%), HOA, predial, fideicomiso fees, vacancy (25-35%), currency conversion costs, and Canadian tax on rental income.
