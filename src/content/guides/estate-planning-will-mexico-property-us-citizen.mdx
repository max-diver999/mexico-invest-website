...
![Mexico property estate planning document](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460775/more-group/mexico/guides/inheritance-property-mexico-foreigner/inline_1.jpg)
...
![Mexico will and Fideicomiso planning](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460776/more-group/mexico/guides/inheritance-property-mexico-foreigner/inline_2.jpg)
...
Falling under the exemption removes the tax question, not the paperwork, and that distinction costs families money. A $400,000 Playa condo sits far below the $13.61 million federal figure, so no estate tax is likely due; what heirs still need is a date-of-death valuation to establish the stepped-up US basis, the CFDI file proving the Mexican acquisition and improvement basis, and the substitute-beneficiary clause in the fideicomiso. Without the CFDI record, a later sale calculates Mexican ISR against whatever the escritura recorded years earlier, and a $120,000 documentation gap can add roughly $25,000 of withholding at closing.
...
## Mexican forced heirship and your plan
...
Two documents, not one, is the practical answer for most US owners of Mexican property. A Mexican will covering only the Mexican asset, granted before a notario público and registered, is typically processed in months; relying on a US will alone means the Mexican succession runs on an authenticated, apostilled and translated foreign document, which routinely adds 6 to 12 months and $3,000 to $8,000 of additional legal cost. The two wills must be drafted so neither revokes the other, which is the single most common drafting error, and both should name the same substitute beneficiaries as the fideicomiso itself.
