...
The mechanics below assume you have already worked out what Mexico takes. [ISR and the RFC registration behind it](/guides/sat-rental-registration-mexico/) come first, because the Mexican tax paid is the input to your [Form 1116 foreign tax credit](/guides/form-1116-foreign-tax-credit-mexico-rental/). Owners holding coastal property through a bank trust also file [FBAR](/guides/fbar-mexico-real-estate/) and [FATCA Form 8938](/guides/fatca-mexico-property-owners/), filings, not taxes.
...
Depreciation is the deduction that most often turns a positive-cash-flow Mexican condo into a paper loss on a US return, and the worked example below shows why. On a $300,000 purchase with land estimated at 20%, the $240,000 depreciable basis produces $8,727 of annual deduction. A Playa del Carmen 1BR grossing $21,000 with $9,000 of management, HOA, predial and trust fees nets about $12,000 of cash; subtract the $8,727 and taxable Schedule E income falls to roughly $3,300. The cash is real and the tax is small, but the deduction is not free: every dollar claimed reduces basis and comes back as depreciation recapture taxed at up to 25% when you sell.
...
Separating creditable from deductible Mexican taxes changes the outcome by real money, and the split catches most first-year filers. Mexican ISR withheld on rental income is creditable dollar-for-dollar against US tax on that same income through Form 1116; predial, ISAI paid at purchase and municipal permit fees are not, and belong on Schedule E as ordinary deductions worth only your marginal rate. On a Riviera Maya condo where the platform withholds ISR at rates that can reach 20% of gross, a US owner in the 24% bracket typically extinguishes most of the US liability through the credit, while a $400 predial bill saves only about $96. Treat the two categories separately from the first filing rather than reconciling them later.
...
IRS examinations of foreign rental property rarely turn on whether the income was reported. They turn on whether the taxpayer can substantiate what they reported, and on whether the exchange rate methodology was applied consistently across the return and across years. Those two things, documentation quality and currency consistency, account for most adverse outcomes on Schedule E foreign property, and both are entirely within your control at the point the records are created rather than at the point they are requested. Build the system below once, in the year you buy, and it carries through the whole hold.
...
The mistakes below are predictable enough to list, which means they are avoidable enough to plan around. Three categories account for nearly all of them. Unreported income, usually justified by the belief that money staying in Mexico is not US-taxable or that Mexican ISR satisfies the US obligation, neither is true for a US person, who is taxed on worldwide income. Currency conversion errors, from inconsistent methodology or commercial bank rates where Treasury rates are expected. And foreign tax credit misapplication, most often claiming predial as an income tax credit when it belongs as a Schedule E deduction.
