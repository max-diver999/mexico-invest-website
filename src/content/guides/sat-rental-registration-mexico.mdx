...
For the RFC registration process specifically, see [Getting an RFC Tax ID as a Non-Resident](/guides/non-resident-tax-id-rfc-guide/). For the IVA dimension of short-term rentals, see [VAT on Mexico Property Rental](/guides/vat-mexico-property-rental/).
