...
A Mexican closing needs your physical signature in front of a notario on four separate documents, spread across weeks you cannot predict. A power of attorney, a poder, lets someone sign those for you, which is why the large majority of US and Canadian purchases use one. It substitutes for your presence at the signing, not for your diligence beforehand.
...
![Motul, Yucatán](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460855/more-group/mexico/guides/power-of-attorney-property-mexico/inline_1.jpg)
...
Cost and calendar both favour signing in Mexico, and the gap is worth planning around. The US route runs 2 to 4 weeks and stacks attorney drafting, notarisation, a state apostille at $25 to $50 with expediting, certified Spanish translation and Mexican validation. Signing before a Mexican notario during a diligence trip costs roughly $200 to $500 all in, needs no apostille and no translation, and removes 1 to 2 weeks from the closing calendar. For a buyer who is visiting the property anyway, the poder should be on the same trip's agenda as the inspection.
...
Signing the poder in front of a Mexican notario while you are already in the country is faster and cheaper than doing it at home: $200–500 in fees, no apostille, and one to two weeks saved. Most buyers grant it during the diligence trip and close remotely a fortnight later, which is the right order, because the trip is where the diligence happens.
...
Bank KYC is the constraint that a power of attorney does not solve, and buyers discover it late. Mexican banks must identify the actual trust beneficiary before constituting a fideicomiso, so passport, proof of address, source-of-funds documentation and often a video or in-person verification are required from you personally, regardless of who signs the deed. Sequence the bank file first, the trust approval second and the notario appointment third; a POA that arrives before the bank has cleared KYC saves nobody time and closings routinely slip 2 to 3 weeks on exactly this.
...
A poder is revocable and revocation is same-day work through a notario, but it only protects you if you use it before something is signed. Four triggers should produce an immediate revocation rather than a conversation: the relationship ending, a signing request you did not expect, diligence failing while pressure to close continues, or any change to wire instructions.
...
An LLC holding the beneficial interest in a fideicomiso, signed for under a power of attorney, is three structures deep, and Mexican notarios do not uniformly accept foreign entity POAs. This is the one configuration where a do-it-yourself document reliably fails at the closing table. Have cross-border counsel draft it and confirm acceptance with the specific notario in advance.
...
A limited poder is safe in proportion to how narrowly it is drawn. The four constraints below, one named property, no authority to change price, funds only to a named account, and a fixed expiry, remove most of the ways a power of attorney is abused. These are concepts for your attorney to draft from, not language to copy.
...
## Educational scenario: a Texas buyer grants POA

Signing at home rather than in Mexico costs about three weeks, and this sequence shows where they go: the US notarisation is immediate, the Texas Secretary of State apostille takes most of week two, and validation by the Mexican attorney takes week three. Plan the closing date from the apostille, not from the signature.
...
A poder notarial makes a remote closing possible and does nothing else, which is precisely the distinction buyers lose sight of. Done properly it is limited in scope, held by your own attorney rather than the seller's, apostilled on a schedule that does not delay closing, and structured so that wire approval stays with you. Done carelessly it grants broad authority to someone else's counsel and removes you from the only decision that matters. It is a tool for executing a transaction you have already diligenced, not a substitute for escrow, due diligence or independent representation.
