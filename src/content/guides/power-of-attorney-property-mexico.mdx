...
<CtaBox
  title="A power of attorney is drafted for one job"
  description="Send us what you need executed and we will come back with the scope the document must carry, where it should be signed, and how it is revoked."
