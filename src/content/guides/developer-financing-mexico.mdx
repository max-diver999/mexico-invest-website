...
Before signing any developer-financed purchase in Mexico, verify each item: The single most important item on the list is who holds the money between milestones: an independent escrow agent, or the developer.
