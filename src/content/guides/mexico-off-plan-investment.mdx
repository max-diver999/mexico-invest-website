...
![Golf Riviera 26 11zon](https://res.cloudinary.com/dphvjbqb4/image/upload/w_960,q_85,f_webp/v1781460805/more-group/mexico/guides/mexico-off-plan-investment/inline_1.jpg)
...
Discount only survives if it exceeds the carry, and the carry is larger than most buyers model. Capital committed to a 24-month build earns nothing while a delivered Playa condo at 4.4% net on $310,000 returns roughly $13,640 a year, or $27,280 across the same period. Add furnishing at $15,000 to $30,000 and a 3 to 6 month ramp to first booking, and an off-plan purchase needs a discount above 12% — roughly $37,000 on a $310,000 comparable — simply to draw level with buying delivered product today.
...
Closing stack: [Cost of buying property Mexico](/guides/cost-of-buying-property-mexico/) · [Mexico property closing costs breakdown](/guides/mexico-property-closing-costs-breakdown/).
...
## Geographic strategy: where off-plan works, and where it fails

Off-plan is not one Mexico bet. Micro-market supply and infrastructure at delivery determine whether your discount survives. In 2026 that resolves clearly: off-plan works in supply-constrained Los Cabos and Puerto Vallarta, and fails in Tulum, where the discount is smaller than the negotiating room already available on delivered resale.

Market choice matters more in off-plan than in resale because you are underwriting absorption as well as construction. Tulum's 2023-to-2025 cycle left unfinished phases and a Region 15 overhang still clearing past 74 days on market, so a buyer there carries completion risk and exit risk together. Playa del Carmen and Puerto Vallarta have deeper developer track records and thinner new supply. Ask how many buildings the developer has delivered and titled in that specific municipality, and treat fewer than 2 as construction risk rather than a yield play.
...
## Off-plan yield modeling: gross marketing

Never underwrite off-plan from gross yield on purchase price alone. Build a delivery-year model with conservative occupancy, full management stack, and stressed HOA. And add the line most models omit entirely: two years of carry — trust fees plus the rental income a delivered alternative would have earned — which frequently exceeds the launch discount that justified buying off-plan.
...
Off-plan exit is not flip-friendly. Most contracts restrict assignment; resale liquidity begins at delivery. Plan hold period 24–36 months minimum after keys to recover furnishing, closing, and first-year operating drag. Which makes the assignment clause the single most valuable term to negotiate at signing. Without a written right to assign, your first realistic exit is 24–36 months after deposit, into whatever market exists at delivery.
...
Work these in order, because each one can end the purchase before the next is worth paying for. Verify the construction licence and final environmental clearance by file number at the municipio; confirm an independent escrow agent holds funds with releases against engineer sign-off; get delay penalties, delivery specification and assignment rights in writing; and walk a delivered building by the same developer before signing for one that does not exist.
