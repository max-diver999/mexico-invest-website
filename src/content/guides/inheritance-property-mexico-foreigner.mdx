...
For the ownership context before inheritance issues arise, review [Fideicomiso Mexico Explained](/guides/fideicomiso-mexico-explained/) and [Buy Property in Mexico as Foreigner](/guides/can-foreigners-buy-property-mexico/).

![Merida Playa Progreso](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460775/more-group/mexico/guides/inheritance-property-mexico-foreigner/inline_1.jpg)

![Mérida Cenote](https://res.cloudinary.com/dphvjbqb4/image/upload/v1781460776/more-group/mexico/guides/inheritance-property-mexico-foreigner/inline_2.jpg)
...
Documentation gaps are inherited along with the property, and the table above understates how expensive that is. An heir who receives a Playa condo their parent bought for $250,000 in 2015 without CFDI invoices, and who later sells at $420,000, may find the notario calculating ISR against the original recorded price rather than a stepped-up value at death. On a $170,000 gain at the 35% net method that is roughly $59,500 of withholding, against perhaps $10,000 if an estate appraisal and complete invoice trail had established market value at death. The remedy costs a few thousand dollars and has to happen during the succession, not afterwards.
...
Two systems apply simultaneously and neither waits for the other. Mexican succession runs through a notario and, where a foreign will is used, requires apostille and certified translation that commonly add 6 to 12 months. US executors meanwhile face their own deadlines: Form 706 is due 9 months after death where a return is required, and the date-of-death valuation needed for the US stepped-up basis is the same appraisal the Mexican side needs for ISR purposes. Commissioning one appraisal that satisfies both, early, is the single highest-value action an heir can take.
...
Almost every expensive Mexican inheritance problem is cheap to prevent and costly to cure, and the gap between those two numbers is measured in years rather than dollars. A beneficiary designation updated during the owner's lifetime costs a bank fee and an afternoon; the same correction after death runs through a formal court succession that commonly takes 12 to 18 months and consumes legal fees an order of magnitude larger. The four patterns below account for the majority of what goes wrong in foreign estate proceedings over Mexican property, stale fideicomiso successor designations, wills that contradict each other across jurisdictions, missing CFDI documentation that destroys the cost basis, and heirs who cannot be located or will not cooperate. Each is followed by the resolution path and the preventive step that would have avoided it:
...
<CtaBox
  title="Succession here depends on how title is held"
  description="Send us the ownership structure and we will come back with how the property passes, what the trust beneficiary substitution involves, and where probate would run."
...
A Mexican inheritance with foreign heirs is not a task any single professional can complete, and the DIY attempts that come through notario offices generally fail at the seam between two jurisdictions rather than inside either one. You need a Mexican inheritance attorney licensed in the state where the property sits, a notario público to validate the succession documents, and a Mexican tax advisor for estate compliance and future ISR planning. On the home-country side you need an estate attorney who will draft around the Mexican asset rather than over it, and a cross-border CPA who understands both the US estate tax exposure and the foreign tax credit mechanics. Budget for a coordinating role as well, somebody has to hold the two sides to the same timeline, and by default nobody does:
