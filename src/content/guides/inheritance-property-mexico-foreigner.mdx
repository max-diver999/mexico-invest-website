...
- **Forced heirship concepts** — legitimate portion (legítima) may restrict complete testamentary freedom in some cases
...
**Authentication chain example:** Death certificate → County clerk certification → Secretary of State apostille → Mexican authorized translator → certified translation for court filing

All foreign documents require both apostille authentication and certified Spanish translation before Mexican legal proceedings can begin.
...
| Cost | Court fees, attorney fees, certified translations, notifications |
...
| Cost | Consular fees lower than court proceedings |
...
**Resolution:** Formal court succession process to determine valid heirs and establish new beneficiary registry. Timeline extends to 12-18 months with legal fees.
...
**Resolution:** Emergency SRE renewal petition with inheritance proceedings documentation. Risk of property reverting to Mexican state if renewal fails.
