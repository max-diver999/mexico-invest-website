...
Garza Blanca offers residences across several unit types within the resort, from smaller suites to large penthouses and garden residences. Unlike a standalone condo, the unit type here mostly decides which slice of the resort's demand you are exposed to rather than how much space you own. Smaller suites clear the highest occupancy because couples are the resort's deepest market; penthouses carry the ADR but sit empty through shoulder season, which is why the yield ranking across this table runs opposite to the price ranking.
...
The Tafer revenue split is the defining financial variable for Garza Blanca investment analysis. A conservative but realistic model for a 1BR ocean-view unit: The line that decides this investment is the 50% operating share, and it is deducted from gross room revenue before HOA, property tax or your own capital cost. On a $87,600 gross that is $43,800 gone before you have paid a single expense of your own — so the honest test of Garza Blanca is not whether the resort fills rooms (it does) but whether half of what it collects still covers a return on a $700K–$950K ticket.
...
## HOA at garza blanca: resort infrastructure
...
Condo-hotel programs typically impose restrictions on personal use during peak season to maximize hotel occupancy and therefore owner revenue. At Garza Blanca, personal use is allowed but subject to: This is where condo-hotel buyers most often feel misled, because the restriction is structural rather than negotiable: the weeks you most want — Christmas, New Year, Semana Santa — are the same weeks the program earns its ADR, and every night you take out of inventory is revenue removed from your own distribution. Price the personal use honestly at the resort's peak nightly rate and decide whether you would pay that, because in effect you are.
...
In a condo-hotel the operator holds most of the levers, and the risk list reflects that. Four of the five items below are contract questions rather than property questions: whether Tafer can modify the programme unilaterally, what happens to owner rights if the operator changes or exits, how peak-season personal use is restricted, and what the revenue share has actually produced. Ask for three years of audited occupancy and ADR before accepting any projection at this $520K entry, and read the modification clauses closely — they determine whether the terms you signed are the terms you keep.
...
At $520,000 in a condo-hotel, four of the five checks below are about the operating agreement rather than the building, because that is where the economics live. Read the managed programme contract in full — the revenue split, the length of the obligation and the exit terms are the three numbers that determine your return, and a summary sheet omits all three. Request Tafer's actual occupancy and ADR for your unit type over the last three years rather than a projection. Then the HOA: current level, historical increase rate, reserve balance, and any capital improvements already planned but not yet levied.

1. Fideicomiso: confirm title structure, trust bank, and beneficiary rights in full. The managed-program contract is the document that matters most here, and the summary sheet the sales office hands over is not it. Ask for the executed agreement in full and read for three things specifically: the length of the obligation, the exit terms, and whether the split is struck on gross or net room revenue — that last distinction alone can move your return by several hundred basis points.
