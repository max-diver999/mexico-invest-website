...
Context: [Tulum Real Estate](/areas/tulum/). Developer track: [Amara Tulum](/projects/amara-tulum/).
...
<CtaBox
  title="Jungle plots need the title chain read carefully"
  description="Send us the parcel and we will come back with what the registry shows, whether ejido appears anywhere in the chain, and what the access arrangement is."
