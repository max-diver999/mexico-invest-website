...
<CtaBox
  title="A branded resort address is mostly a rental contract"
  description="Tell us the unit and we will come back with the split, the blackout periods, the fee load and what comparable units have achieved net of all of it."
