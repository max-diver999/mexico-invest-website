...
readingTime: 15
heroImage: "https://res.cloudinary.com/dphvjbqb4/image/upload/v1781470268/more-group/mexico/projects/selva-zama-mondo/inline_2.jpg"
...
Context: [Tulum Real Estate](/areas/tulum/)..
...
Master plan context: [Tulum](/areas/tulum/).
...
Tulum hub: [Tulum Property Investment Guide](/areas/tulum/).
...
<CtaBox
  title="Selva Zama is a master plan, so check your phase"
  description="Send us the unit and we will come back with what is complete around it, what is still to be built, and what the density will be when it is finished."
...
The master plan's build-out phase matters more than the render here; the wider market sits on [Tulum](/areas/tulum/), the delivery question in [pre-construction risks in Mexico](/guides/pre-construction-mexico-risks/), and the fee position in [what a Mexican HOA fee covers](/guides/hoa-fees-mexico-condo/).
