...
<CtaBox
  title="Campeche stock is cheap and slow to resell"
  description="Give us the unit and we will come back with the realistic holding period if you needed to exit, and what comparable properties actually achieved."
