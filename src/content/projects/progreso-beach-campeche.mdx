...
## Rental market: domestic tourism and long-stay expats

Progreso and Campeche Gulf properties are not international Airbnb markets in the Cancun/Tulum sense. STR demand is primarily: That distinction sets the whole underwriting. Domestic weekend demand from Mérida concentrates into Fridays, Saturdays and Mexican holiday periods, which produces high peak occupancy and a thin midweek; expat long-stays at $800–$1,500 a month produce the opposite — low ADR, near-full occupancy, negligible turnover cost. Most owners here end up running long-stay as the base and selling weekends at a premium on top.
...
The single most important comparison to make before buying on the Gulf coast is visual. The Gulf of Mexico does not look like the Caribbean. The visual comparison is not an aesthetic footnote — it is the demand model. International guests book the Riviera Maya for turquoise water and the Mesoamerican reef, and neither exists on the Yucatán Gulf coast. A buyer who accepts that is buying a domestic and expat rental business at Gulf prices; a buyer who does not will underwrite Caribbean ADRs against a beach that cannot deliver them.
...
Gulf Coast due diligence shares core requirements with all Mexican coastal real estate but has some specific items. Flood exposure is the item that separates Gulf-coast diligence from Caribbean diligence. Progreso sits barely above sea level and the CENAPRED hazard maps are public, so check the parcel before the offer rather than discovering the classification when you try to insure it — coverage on a mapped flood zone is materially more expensive and occasionally unavailable.
...
Several macro trends support long-term Gulf Coast appreciation: The honest weighting on this list is that the first two are already happening and the second two are forecasts. Mérida's North American population and its nearshoring-driven professional base are measurable today and are what actually support Progreso rents; the Tren Maya and digital-nomad effects are directional and should not carry weight in a purchase decision made in 2026.
