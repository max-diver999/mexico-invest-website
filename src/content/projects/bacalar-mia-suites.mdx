...
heroCredit: "Developer marketing image. The pins mark Los Cabos landmarks, Marina Puerto Los Cabos, Club Vidanta Golf, not Bacalar."
priceFromUsd: 340000
area: "bacalar"
...
| Revenue scenario | ADR | Occupancy | Gross/year | On $367K all-in |
|---|---|---|---|---|
| Conservative | $380 | 55% | $76,285 | ~20.8% gross / ~12.5% net |
| Base case | $450 | 62% | $101,745 | ~27.7% gross / ~17.5% net |
| Optimistic | $550 | 68% | $136,510 | ~37.2% gross / ~24.3% net |

**Read these as projections under good conditions, not as reported results.** Every figure above is derived from the developer's ADR and occupancy assumptions, and the implied returns sit far outside anything the Mexican coastal market has been observed to produce; this site's own corridor data puts full-year averages at 5.5-7% gross and 4.3-5.2% net in Playa del Carmen, the most liquid short-term-rental market on the peninsula, and Bacalar's management and guest infrastructure is materially thinner than Playa's. A $380 nightly rate at 55% occupancy against a $340,000 ticket implies a price-to-revenue relationship that almost nothing in Mexico sustains across a full year. Treat the table as the developer's case, ask for two years of actual distributions from an operating Mia property before accepting any of it, and model your own downside at 35-40% occupancy on a $250-280 rate.

Note: net yield after 28% managed program fee, HOA $200–400/month, insurance, maintenance, predial and trust fee, on a $367,200 all-in basis (price plus ~8% closing). The Mia branded management program is a prerequisite for the above ADR, self-managed without brand affiliation typically achieves 25–40% lower ADR. The branded program fee (28%) is above-market but justified by the brand's existing booking infrastructure and destination authority. Yield guide: [Mexico Rental Yield Guide](/guides/mexico-rental-yield-guide/).
...
Bacalar's lagoon is the reason for the price and the reason for the paperwork. A branded residence starting at $340K on a federally protected shoreline carries two layers of environmental exposure that a standard Riviera Maya condo does not: SEMARNAT authorization for the project itself, verifiable by permit number on semarnat.gob.mx, and a ZOFEMAT boundary that must be surveyed from the lagoon's natural shoreline rather than estimated from a rendering. Settle both before you look at the management contract, because neither is negotiable and neither can be fixed after closing.
