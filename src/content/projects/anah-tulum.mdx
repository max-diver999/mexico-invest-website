...
<TldrBlock text="Anah Tulum is a classic off-plan condo in Tulum from $195,000 USD with a lock-off 2BR option for independent dual-side STR. 1BR entry nets 4.5–5.5% indicatively; lock-off 2BR can improve yield by 20–35% vs. standard 2BR operation. Foreign ownership in Tulum is held through a trustee bank. Verify HOA permits dual-unit STR before committing." />
...
Lock-off strategy context: [Tulum](/areas/tulum/). Yield methodology: [Mexico Rental Yield Guide](/guides/mexico-rental-yield-guide/).
...
<CtaBox
  title="Aldea Zama pricing against the rest of Tulum"
  description="Tell us your budget and we will come back with what this address costs against comparable inland stock, with the rental permission position on each."
