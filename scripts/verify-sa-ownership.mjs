#!/usr/bin/env node
/**
 * Verify SA ownership for mexico-invest.com via Site Verification API.
 *
 * Usage:
...
const SITE_URL = 'https://mexico-invest.com/';
...
async function getToken() {
  ...
  console.log(`  2. Verify file is live: curl https://mexico-invest.com/${token}`);
