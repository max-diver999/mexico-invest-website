 ...
 *
 * Usage (from mexico-invest-website/):
...
function main() {
  ...
  const payload = {
    ...
    source: {
      manifest: 'mexico-invest-website/scripts/mexico-project-images-all.json',
      content: 'mexico-invest-website/src/content/projects/*.mdx',
    },
